...
test("P2 invariant: normalizer aligns intensity/eligible to the decision step (port's Phase 6 contract normalizer — step-driven, not a cap-only normalizer like LIOSH's)", () => {
  ...
  assert.equal(normalized.intensity, "RI2");
