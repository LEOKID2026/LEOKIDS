...
test("P4 contract unit test: injected-canonical-state cases match authorization and RI caps (NOT a raw-evidence benchmark — see decision-engine-e2e-benchmark.test.mjs)", () => {
  assert.equal(BENCHMARK.length, Object.keys(PROFILES).length * 2);
