/**
 *     V2     —     analyzeLearningPatterns   detailed.
 */
...
/**     patternDiagnostics   (  JSON  ) —   analyzeLearningPatterns */
...
export function mathWrongCluster(n, patternFamily = "pf:fixture_gap") {
  ...
  return Array.from({ length: n }, (_, i) => ({
    ...
    isCorrect: false,
    exerciseText: `EN fixture 16nXkNec16 Addition ${i}`,
    correctAnswer: 8,
    userAnswer: 3,
    patternFamily,
    hintUsed: true,
...
export function mathRowSession(opts) {
  ...
  return {
    ...
    displayName: opts.displayName || "Addition",
    questions: q,
    correct,
    wrong: q - correct,
    accuracy: acc,
...
/**       —   baseReport    buildDetailedParentReportFromBaseReport */
export const PARENT_REPORT_SCENARIOS = {
      ...
      mathOperations: {
        [FIXTURE_MATH_ROW_ADD_LEARN_G4_MED]: mathRowSession({
          ...
          topicEngineRowSignals: {
            ...
            whyThisRecommendationHe: "EN fixture ZnJhZ2lsZV",
          },
        }),
      },
      mistakes: { math: mathWrongCluster(5) },
      ...
      mathOperations: {
        [FIXTURE_MATH_ROW_ADD_LEARN_G4_MED]: mathRowSession({
          ...
          trend: {
            ...
            confidence: 0.55,
            summaryHe: "EN fixture 15TXk9eZ15",
          },
        }),
      },
      mistakes: { math: mathWrongCluster(5) },
    ...
    buildSyntheticBaseReport({
      ...
      mistakes: {
        ...
        geometry: Array.from({ length: 6 }, (_, i) => ({
          ...
          isCorrect: false,
          exerciseText: "EN fixture 15TXmden16",
          correctAnswer: 20,
          userAnswer: 12,
      ...
      mathOperations: {
        [FIXTURE_MATH_ROW_ADD_LEARN_G4_MED]: mathRowSession({
          ...
          topicEngineRowSignals: {
            ...
            diagnosticType: "fragile_success",
            whyThisRecommendationHe: "EN fixture 15nXqSDXl9",
          },
        }),
      },
      mistakes: { math: mathWrongCluster(5) },
  ...
  /**
   * Phase 6 hardening —       +     +             (  recentTransitionRisk  recentDifficultyIncrease).
   */
      ...
      mathOperations: {
        [FIXTURE_MATH_ROW_ADD_LEARN_G4_MED]: mathRowSession({
          ...
          trend: {
            ...
            fluencyDirection: "flat",
            confidence: 0.55,
            summaryHe: "EN fixture 15nXqNeZ15",
            windows: {
      ...
      geometryTopics: {
        "perimeter\u0001learning": {
          ...
          trend: {
            ...
            fluencyDirection: "flat",
            confidence: 0.42,
            summaryHe: "EN fixture 15PXmdeV16",
            windows: {
