...
test("selector count is 80 with ar-001 visible once", () => {
  assert.equal(getSelectableLocales().length, 80);
...
test("locale picker includes ar-001 and selectable count stays 80", async () => {
