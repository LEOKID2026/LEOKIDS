...
async function main() {
  ...
  reportLines.push(
    "- A more precise, code-level instance of root cause #10 (owner narrative missing for WE3/WE4) was located: " +
      ...
      "from the periodic subject letter (`buildTopicRecommendationNarrative` in `utils/detailed-report-parent-letter.js`, " +
