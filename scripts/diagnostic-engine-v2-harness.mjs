...
const MATRIX = [
  {
    ...
    row: row({ displayName: "", questions: 4, correct: 3, wrong: 1, accuracy: 75 }),
  ...
  },
  {
    ...
    row: row({ displayName: "", questions: 18, correct: 16, wrong: 8, accuracy: 89 }),
  ...
  },
  {
    ...
    row: row({ displayName: "", questions: 16, correct: 12, wrong: 4, accuracy: 75, behaviorType: "fragile_success" }),
  ...
  },
  {
    ...
    row: row({ displayName: "", questions: 24, correct: 22, wrong: 2, accuracy: 92, behaviorType: "stable_mastery" }),
    mistakes: [],
  ...
  },
  {
    ...
    row: row({ displayName: " ", questions: 20, correct: 10, wrong: 10, accuracy: 50 }),
  ...
  },
  {
    ...
    row: row({ displayName: " ", questions: 18, correct: 9, wrong: 9, accuracy: 50 }),
  ...
  },
  {
    ...
    row: row({ displayName: " ", questions: 16, correct: 12, wrong: 4, accuracy: 75 }),
  ...
  },
  {
    ...
    row: row({ displayName: " ", questions: 14, correct: 9, wrong: 5, accuracy: 64, modeKey: "speed", behaviorType: "speed_pressure" }),
  ...
  },
  {
    ...
    row: row({ displayName: "", questions: 17, correct: 11, wrong: 6, accuracy: 65 }),
  ...
  },
  {
    ...
    row: {
      ...row({ displayName: "", questions: 19, correct: 11, wrong: 8, accuracy: 58 }),
  ...
  },
  {
    ...
    row: row({ displayName: " ", questions: 18, correct: 14, wrong: 4, accuracy: 78 }),
  ...
  },
  {
    ...
    row: row({ displayName: " ", questions: 15, correct: 11, wrong: 4, accuracy: 73 }),
  ...
  },
  {
    ...
    row: row({ displayName: "", questions: 5, correct: 1, wrong: 4, accuracy: 20 }),
  ...
  },
  {
    ...
    row: row({ displayName: "", questions: 12, correct: 10, wrong: 7, accuracy: 83 }),
