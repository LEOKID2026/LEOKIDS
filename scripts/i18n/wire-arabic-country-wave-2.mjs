/**
 * Shared wiring for Arabic country wave 2: ar-IQ, ar-JO, ar-AE, ar-TN.
 * Wires load-messages.js + pack-catalog.js from on-disk sparse overlays.
 * Does NOT modify country content.
 *
 * Run: node scripts/i18n/wire-arabic-country-wave-2.mjs
 */
...
const LOCALES = ["ar-IQ", "ar-JO", "ar-AE", "ar-TN"];
...
function wireLoadMessages() {
  ...
  // Insert after Wave 1 ar-DZ worksheets import (stable anchor).
  const anchorImport =
    'import worksheetsArDZ from "../../locales/ar-DZ/worksheets.json" with { type: "json" };';
  if (!src.includes(anchorImport)) {
    throw new Error("load-messages Wave 2 anchor import not found");
  }
