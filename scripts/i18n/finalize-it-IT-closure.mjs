      ...
      return part
        ...
        .map((line) => {
          ...
          if (englishSubject) {
            ...
            if ((line.match(/`/g) || []).length >= 2 && !/Book title|Child-facing|Status|Naming|Batch|Current Status|Folder|Date|אנגל|עבר|כיתה|אוצר/.test(line)) {
              return line;
            }
            // always clear Hebrew
...
function translateHebrewLine(line) {
  ...
  const map = [
    ...
    [/ספר אנגלית — כיתה ג׳/g, "Libro di Inglese — 3ª primaria"],
    [/ספר אנגלית — כיתה ד׳/g, "Libro di Inglese — 4ª primaria"],
    [/ספר אנגלית — כיתה ה׳/g, "Libro di Inglese — 5ª primaria"],
    [/ספר אנגלית — כיתה ו׳/g, "Libro di Inglese — 1ª secondaria"],
    [/ספר מתמטיקה — כיתה א׳/g, "Libro di Matematica — 1ª primaria"],
    [/ספר מתמטיקה — כיתה ב׳/g, "Libro di Matematica — 2ª primaria"],
    [/ספר מתמטיקה — כיתה ג׳/g, "Libro di Matematica — 3ª primaria"],
    [/ספר מתמטיקה — כיתה ד׳/g, "Libro di Matematica — 4ª primaria"],
    [/ספר מתמטיקה — כיתה ה׳/g, "Libro di Matematica — 5ª primaria"],
    [/ספר מתמטיקה — כיתה ו׳/g, "Libro di Matematica — 1ª secondaria"],
    [/ספר גאומטריה — כיתה א׳/g, "Libro di Geometria — 1ª primaria"],
    [/ספר גאומטריה — כיתה ב׳/g, "Libro di Geometria — 2ª primaria"],
    [/ספר גאומטריה — כיתה ג׳/g, "Libro di Geometria — 3ª primaria"],
    [/ספר גאומטריה — כיתה ד׳/g, "Libro di Geometria — 4ª primaria"],
    [/ספר גאומטריה — כיתה ה׳/g, "Libro di Geometria — 5ª primaria"],
    [/ספר גאומטריה — כיתה ו׳/g, "Libro di Geometria — 1ª secondaria"],
    [/ספר מדעים — כיתה א׳/g, "Libro di Scienze — 1ª primaria"],
    [/ספר מדעים — כיתה ב׳/g, "Libro di Scienze — 2ª primaria"],
    [/ספר מדעים — כיתה ג׳/g, "Libro di Scienze — 3ª primaria"],
    [/ספר מדעים — כיתה ד׳/g, "Libro di Scienze — 4ª primaria"],
    [/ספר מדעים — כיתה ה׳/g, "Libro di Scienze — 5ª primaria"],
    [/ספר מדעים — כיתה ו׳/g, "Libro di Scienze — 1ª secondaria"],
    [/\bאנגלית\b/g, "Inglese"],
    [/\bמתמטיקה\b/g, "Matematica"],
    [/\bגאומטריה\b/g, "Geometria"],
    [/\bמדעים\b/g, "Scienze"],
    ...
    [/בסיס/g, "base"],
    [/תרגום כיתה/g, "Traduzione in classe"],
