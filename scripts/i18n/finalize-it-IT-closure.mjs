...
function translateHebrewLine(line) {
  ...
  const map = [
    ...
    [/  —  /g, "Libro di Inglese — 3ª primaria"],
    [/  —  /g, "Libro di Inglese — 4ª primaria"],
    [/  —  /g, "Libro di Inglese — 5ª primaria"],
    [/  —  /g, "Libro di Inglese — 1ª secondaria"],
    [/  —  /g, "Libro di Matematica — 1ª primaria"],
    [/  —  /g, "Libro di Matematica — 2ª primaria"],
    [/  —  /g, "Libro di Matematica — 3ª primaria"],
    [/  —  /g, "Libro di Matematica — 4ª primaria"],
    [/  —  /g, "Libro di Matematica — 5ª primaria"],
    [/  —  /g, "Libro di Matematica — 1ª secondaria"],
    [/  —  /g, "Libro di Geometria — 1ª primaria"],
    [/  —  /g, "Libro di Geometria — 2ª primaria"],
    [/  —  /g, "Libro di Geometria — 3ª primaria"],
    [/  —  /g, "Libro di Geometria — 4ª primaria"],
    [/  —  /g, "Libro di Geometria — 5ª primaria"],
    [/  —  /g, "Libro di Geometria — 1ª secondaria"],
    [/  —  /g, "Libro di Scienze — 1ª primaria"],
    [/  —  /g, "Libro di Scienze — 2ª primaria"],
    [/  —  /g, "Libro di Scienze — 3ª primaria"],
    [/  —  /g, "Libro di Scienze — 4ª primaria"],
    [/  —  /g, "Libro di Scienze — 5ª primaria"],
    [/  —  /g, "Libro di Scienze — 1ª secondaria"],
    [/\b\b/g, "Inglese"],
    [/\b\b/g, "Matematica"],
    [/\b\b/g, "Geometria"],
    [/\b\b/g, "Scienze"],
