...
const LINE_FIX = [
  ...
  [/English book — Grade 1/g, "Engels — Groep 3"],
  [/English book — Grade 2/g, "Engels — Groep 4"],
  [/English book — Grade 3/g, "Engels — Groep 5"],
  [/English book — Grade 4/g, "Engels — Groep 6"],
  [/English book — Grade 5/g, "Engels — Groep 7"],
  [/English book — Grade 6/g, "Engels — Groep 8"],
  [/Math book/g, "Rekenen-boek"],
  [/Geometry book/g, "Meetkunde-boek"],
  [/Science book/g, "Natuur-en-techniekboek"],
  [/Grade 1['']?/g, "Groep 3"],
  [/Grade 2['']?/g, "Groep 4"],
  [/Grade 3['']?/g, "Groep 5"],
  [/Grade 4['']?/g, "Groep 6"],
  ...
  [/\*\*English\*\*/g, "**Engels**"],
  [/\*\*Math\*\*/g, "**Rekenen**"],
  [/\*\*Geometry\*\*/g, "**Meetkunde**"],
  [/\*\*Science\*\*/g, "**Natuur en techniek**"],
  [/Vocabulary/g, "woordenschat"],
  [/Colors in English/g, "Kleuren in het Engels"],
  [/Numbers 0–10 in English/g, "Getallen 0–10 in het Engels"],
  [/Family in English/g, "Familie in het Engels"],
  [/Animals in English/g, "Dieren in het Engels"],
  [/Feelings in English/g, "Gevoelens in het Engels"],
  [/Verbs in English/g, "Werkwoorden in het Engels"],
  [/School in English/g, "School in het Engels"],
  [/Grammar/g, "grammatica"],
  [/Writing/g, "schrijven"],
  [/Reading/g, "lezen"],
