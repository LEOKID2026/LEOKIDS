/**
 * Shared wiring for Arabic country wave 3: ar-KW, ar-QA, ar-OM, ar-BH.
 * Wires load-messages.js + pack-catalog.js from on-disk sparse overlays.
 * Does NOT modify country content.
 *
 * Run: node scripts/i18n/wire-arabic-country-wave-3.mjs
 */
...
const LOCALES = ["ar-KW", "ar-QA", "ar-OM", "ar-BH"];
...
function wireLoadMessages() {
  ...
  if (!src.includes(anchorImport)) {
    throw new Error("load-messages Wave 3 anchor import not found");
  }
