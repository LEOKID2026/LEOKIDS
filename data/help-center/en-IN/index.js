/**
 * India (en-IN) Help Center sparse overlays on English base articles.
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_EN_IN / ALL_ARTICLES_EN_IN
 * - resolveHelpLocale: treat en-in as en-IN (fallback chain en-IN → en)
 * - getHelpSections / listArticles / getAllArticles branches for en-IN
 *
...
export const ALL_ARTICLES_EN_IN = [
  ...BY_SECTION_EN_IN.parents,
  ...BY_SECTION_EN_IN.students,
  ...BY_SECTION_EN_IN["parent-report"],
  ...BY_SECTION_EN_IN.subjects,
];
