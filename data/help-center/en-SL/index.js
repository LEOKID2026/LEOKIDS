/**
 * Sierra Leone (en-SL) Help Center sparse overlays on English base articles.
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_EN_SL / ALL_ARTICLES_EN_SL
 * - resolveHelpLocale: treat en-sl as en-SL (fallback chain en-SL → en)
 * - getHelpSections / listArticles / getAllArticles branches for en-SL
 *
 * This English layer supports English used in Sierra Leone’s formal education.
 * It does not claim English is the only language spoken in Sierra Leone.
 * Do not wire a generic /sl public path here — planned public path is /sl-en.
 */
...
export const ALL_ARTICLES_EN_SL = [
  ...BY_SECTION_EN_SL.parents,
  ...BY_SECTION_EN_SL.students,
  ...BY_SECTION_EN_SL["parent-report"],
  ...BY_SECTION_EN_SL.subjects,
];
