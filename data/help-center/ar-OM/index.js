/**
 * Oman (ar-OM) Help Center sparse overlays on Arabic Master (ar-001).
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_AR_OM / ALL_ARTICLES_AR_OM / SECTIONS_AR_OM
 * - resolveHelpLocale: treat ar-om as ar-OM (fallback chain ar-OM → ar-001 → en)
 * - getHelpSections / listArticles / getAllArticles branches for ar-OM
 *
...
/** Section shell: طالب / ولي الأمر (Oman MoE / official digital systems). */
export const SECTIONS_AR_OM = {
  parents: {
    key: "parents",
...
export const ALL_ARTICLES_AR_OM = [
  ...BY_SECTION_AR_OM.parents,
  ...BY_SECTION_AR_OM.students,
  ...BY_SECTION_AR_OM["parent-report"],
  ...BY_SECTION_AR_OM.subjects,
];
