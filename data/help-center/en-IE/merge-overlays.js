 ...
 * Top-level fields replace; blocks are patched by id / textIncludes / kind — not by index alone.
 * Copied utility pattern for Ireland (en-IE) sparse Help overlays on English base.
 */
...
function blockMatches(block, patch) {
  ...
  return Boolean(patch.id || patch.kind || patch.textIncludes || patch.altIncludes);
}
