/**
 * England (en-GB) sparse Help overlays for parents — school-year Grade→Year,
 * primary framing, Maths, and headteacher where relevant.
 * Inherit all other articles/fields from English Help content.
 */
