...
/**
 * England (en-GB) Help layer — sparse overlays on English articles.
 * Shared Help locale wiring still required in data/help-center/index.js (not done here).
 */

export const SECTIONS_EN_GB = {
  parents: {
    key: "parents",
...
export const ALL_ARTICLES_EN_GB = [
  ...BY_SECTION_EN_GB.parents,
  ...BY_SECTION_EN_GB.students,
  ...BY_SECTION_EN_GB["parent-report"],
  ...BY_SECTION_EN_GB.subjects,
];
