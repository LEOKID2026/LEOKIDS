/**
 * Jordan (ar-JO) Help Center sparse overlays on Arabic Master (ar-001).
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_AR_JO / ALL_ARTICLES_AR_JO / SECTIONS_AR_JO
 * - resolveHelpLocale: treat ar-jo as ar-JO (fallback chain ar-JO → ar-001 → en)
 * - getHelpSections / listArticles / getAllArticles branches for ar-JO
 *
 * Do not wire a country-only /jo path here — shared agent handles public paths.
 */
...
/** Section shell: طالب (Jordan MoE / Ajyal / OpenEMIS) instead of تلميذ. */
export const SECTIONS_AR_JO = {
  parents: {
    key: "parents",
...
export const ALL_ARTICLES_AR_JO = [
  ...BY_SECTION_AR_JO.parents,
  ...BY_SECTION_AR_JO.students,
  ...BY_SECTION_AR_JO["parent-report"],
  ...BY_SECTION_AR_JO.subjects,
];
