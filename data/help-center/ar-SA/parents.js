/**
 * Saudi Arabia (ar-SA) sparse Help overlays for parents —
 * المرحلة الابتدائية الصف الأول–السادس; طالب; country SEO wording.
 * Base authority: ar-001 (not Egypt/UAE/Jordan copy).
 */
    ...
    blockPatches: [
      {
        ...
        text:
          "Leo Kids عبارة عن مساحة تعليمية لمتعلمي المرحلة الابتدائية في المملكة العربية السعودية (الصف الأول إلى الصف السادس)، مع التدريب على الرياضيات والهندسة واللغة الإنجليزية والعلوم، بالإضافة إلى الألعاب وتقارير التقدم لأولياء الأمور.",
      },
    ],
  },
  "add-students": {
