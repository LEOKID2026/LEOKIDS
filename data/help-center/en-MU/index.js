/**
 * Mauritius (en-MU) Help Center sparse overlays on English base articles.
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_EN_MU / ALL_ARTICLES_EN_MU
 * - resolveHelpLocale: treat en-mu as en-MU (fallback chain en-MU → en)
 * - getHelpSections / listArticles / getAllArticles branches for en-MU
 *
 * Section chrome inherits English SECTIONS unless SECTIONS_EN_MU is wired.
 * This English layer does not represent French, Mauritian Creole, or other languages used in Mauritius.
 * Do not wire a country-only /mu path for this layer.
 */
...
export const ALL_ARTICLES_EN_MU = [
  ...BY_SECTION_EN_MU.parents,
  ...BY_SECTION_EN_MU.students,
  ...BY_SECTION_EN_MU["parent-report"],
  ...BY_SECTION_EN_MU.subjects,
];
