/**
 * Bahrain (ar-BH) Help Center sparse overlays on Arabic Master (ar-001).
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_AR_BH / ALL_ARTICLES_AR_BH / SECTIONS_AR_BH
 * - resolveHelpLocale: treat ar-bh as ar-BH (fallback chain ar-BH → ar-001 → en)
 * - getHelpSections / listArticles / getAllArticles branches for ar-BH
 *
...
/** Section shell: طالب / ولي الأمر (Bahrain MoE). */
export const SECTIONS_AR_BH = {
  parents: {
    key: "parents",
...
export const ALL_ARTICLES_AR_BH = [
  ...BY_SECTION_AR_BH.parents,
  ...BY_SECTION_AR_BH.students,
  ...BY_SECTION_AR_BH["parent-report"],
  ...BY_SECTION_AR_BH.subjects,
];
