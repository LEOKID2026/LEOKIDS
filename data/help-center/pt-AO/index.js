/**
 * Angola (pt-AO) Help layer — sparse overlays on pt-PT Help
 * (which overlays pt-BR).
 * Chain: pt-AO overlays → pt-PT Help → pt-BR Help.
...
export const SECTIONS_PT_AO = SECTIONS_PT_PT;

export const BY_SECTION_PT_AO = {
...
export const ALL_ARTICLES_PT_AO = [
  ...BY_SECTION_PT_AO.parents,
  ...BY_SECTION_PT_AO.students,
  ...BY_SECTION_PT_AO["parent-report"],
  ...BY_SECTION_PT_AO.subjects,
];
