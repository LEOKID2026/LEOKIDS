/**
 * Singapore (en-SG) Help Center sparse overlays on English base articles.
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_EN_SG / ALL_ARTICLES_EN_SG
 * - resolveHelpLocale: treat en-sg as en-SG (fallback chain en-SG → en)
 * - getHelpSections / listArticles / getAllArticles branches for en-SG
 *
...
export const ALL_ARTICLES_EN_SG = [
  ...BY_SECTION_EN_SG.parents,
  ...BY_SECTION_EN_SG.students,
  ...BY_SECTION_EN_SG["parent-report"],
  ...BY_SECTION_EN_SG.subjects,
];
