/**
 * Rwanda (en-RW) Help Center sparse overlays on English base articles.
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_EN_RW / ALL_ARTICLES_EN_RW
 * - resolveHelpLocale: treat en-rw as en-RW (fallback chain en-RW → en)
 * - getHelpSections / listArticles / getAllArticles branches for en-RW
 *
 * Section chrome inherits English SECTIONS unless SECTIONS_EN_RW is wired.
 * This English layer does not represent all languages used in Rwanda.
 */
...
/** Same section shell as English, with learners wording on the students hub. */
export const SECTIONS_EN_RW = {
  parents: {
    key: "parents",
...
export const ALL_ARTICLES_EN_RW = [
  ...BY_SECTION_EN_RW.parents,
  ...BY_SECTION_EN_RW.students,
  ...BY_SECTION_EN_RW["parent-report"],
  ...BY_SECTION_EN_RW.subjects,
];
