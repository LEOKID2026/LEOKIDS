/**
 * Ghana (en-GH) Help Center sparse overlays on English base articles.
 *
 * Shared wiring still required in data/help-center/index.js:
 * - import BY_SECTION_EN_GH / ALL_ARTICLES_EN_GH
 * - resolveHelpLocale: treat en-gh as en-GH (fallback chain en-GH → en)
 * - getHelpSections / listArticles / getAllArticles branches for en-GH
 *
 * Section chrome inherits English SECTIONS unless SECTIONS_EN_GH is wired.
 */
...
export const ALL_ARTICLES_EN_GH = [
  ...BY_SECTION_EN_GH.parents,
  ...BY_SECTION_EN_GH.students,
  ...BY_SECTION_EN_GH["parent-report"],
  ...BY_SECTION_EN_GH.subjects,
];
