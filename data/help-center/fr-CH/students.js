/**
 * Switzerland French (fr-CH) sparse Help overlays for students —
 * grade → année (3P–8P); fix tu conjugations inherited from fr-FR.
 */
...
export const STUDENT_OVERRIDES_BY_SLUG = {
  ...
  "choose-subject-and-grade": {
    title: "Choisis une matière et une année",
    summary: "Comment entrer en pratique dans le sujet que tu as choisi.",
    keywords: ["sujet", "année"],
    blockPatches: [
      {
        kind: "paragraph",
        textIncludes: "ta classe",
        text: "Choisis un sujet dans la liste. Les activités correspondront à ta année (3P à 8P).",
      },
    ],
  },
  "answering-questions": {
