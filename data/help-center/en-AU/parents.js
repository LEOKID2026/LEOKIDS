/**
 * Australia (en-AU) sparse Help overlays for parents — Grade → Year, math → maths, elementary → primary.
 * Inherit all other articles/fields from English (en).
 */
