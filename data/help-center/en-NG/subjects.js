/**
 * Nigeria (en-NG) sparse Help overlays for subjects —
 * Grade → Primary class and Math → Maths only.
 */
  ...
  blockPatches: [
    {
      ...
      text:
        "Practice is designed for children in Primary 1 through Primary 6, matched to primary class.",
    },
    {
      kind: "paragraph",
      textIncludes: "Choose a grade and level",
      text:
        "Choose a primary class and difficulty, answer questions, and get an explanation after each answer.",
    },
  ],
};
    ...
    blockPatches: [
      ...SUBJECT_SHARED_OVERLAY.blockPatches,
      {
        ...
        items: [
          ...
          "Fractions and decimals (upper primary classes)",
          "Word problems",
        ],
      },
      {
    ...
    blockPatches: [
      ...SUBJECT_SHARED_OVERLAY.blockPatches,
      {
        ...
        items: [
          "Area and perimeter",
          "Angles and shapes",
          "Pythagoras (advanced primary classes)",
        ],
      },
    ],
  },
