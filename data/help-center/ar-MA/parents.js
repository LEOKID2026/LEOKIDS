/**
 * Morocco (ar-MA) sparse Help overlays for parents —
 * السنة / التعليم الابتدائي on top of ar-001 Help.
    ...
    blockPatches: [
      {
        ...
        text: "Leo Kids عبارة عن مساحة تعليمية لمتعلّمي التعليم الابتدائي بالمغرب (السنة الأولى إلى السادسة)، مع التدريب على الرياضيات والهندسة واللغة الإنجليزية والعلوم، بالإضافة إلى الألعاب وتقارير التقدم لأولياء الأمور. هذه النسخة العربية للمغرب وليست تمثيلًا حصريًا لكل اللغات المستخدمة في البلاد.",
      },
    ],
  },
