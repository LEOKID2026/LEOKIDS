/**
 * Morocco (ar-MA) Help layer — sparse overlays on ar-001 Help.
 * Chain intended at wiring time: ar-MA → ar-001 → en.
...
export const SECTIONS_AR_MA = SECTIONS_AR_001;

export const BY_SECTION_AR_MA = {
...
export const ALL_ARTICLES_AR_MA = [
  ...BY_SECTION_AR_MA.parents,
  ...BY_SECTION_AR_MA.students,
  ...BY_SECTION_AR_MA["parent-report"],
  ...BY_SECTION_AR_MA.subjects,
];
