/**
 * Republic of the Congo (fr-CG) sparse Help overlays for subjects —
 * CP/6e and grade « classe » → CP1–CM2 / année + niveau de difficulté.
 */
...
const SUBJECT_BLOCK_PATCHES = [
  {
    ...
    text:
      "La pratique est conçue pour les enfants du CP1 au CM2, en fonction de l’année scolaire.",
  },
  {
    kind: "paragraph",
