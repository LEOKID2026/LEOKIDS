/**
 * Republic of the Congo (fr-CG) sparse Help overlays for students —
 * grade → année; fix tu + vous conjugation leaks inherited from fr-FR.
 */
    ...
    blockPatches: [
      {
        ...
        text: "Choisis un sujet dans la liste. Les activités correspondront à ta année.",
      },
    ],
  },
  "answering-questions": {
