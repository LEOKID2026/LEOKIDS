...
function refreshSchoolUiBindings() {
  ...
  SCHOOL_REPORT_LOAD_ERROR = portalPack().reportLoadError || portalPack().loadError;
  SCHOOL_MESSAGES_LOAD_ERROR = portalPack().messagesLoadError || portalPack().loadError;
  SCHOOL_CHILDREN_LOAD_ERROR = portalPack().childrenLoadError || portalPack().loadError;
  SCHOOL_PERMISSIONS_UPDATE_ERROR =
    portalPack().permissionsUpdateError || portalPack().loadError;
  SCHOOL_PORTAL_LOAD_ERROR = portalPack().portalLoadError || portalPack().loadError;
  ...
  SCHOOL_NETWORK_ERROR = portalPack().networkError || portalPack().loadError;
  SCHOOL_TEACHER_DETAIL_NETWORK_ERROR =
    portalPack().teacherDetailNetworkError || portalPack().networkError || portalPack().loadError;
  SCHOOL_NO_TEACHER_ID = portalPack().noTeacherId;
  SCHOOL_NO_TEACHER_ID_IN_URL = portalPack().noTeacherIdInUrl;
  SCHOOL_AUTHORIZED_SUBJECTS = portalPack().authorizedSubjects;
  SCHOOL_BACK_TO_ACTIVITIES = portalPack().backToActivities;
  SCHOOL_MONITOR_CHILDREN_QUESTIONS = portalPack().monitorChildrenQuestions;
  SCHOOL_CLASS_ACCURACY = portalPack().classAccuracy;
  SCHOOL_COL_ANSWERS = portalPack().colAnswers;
  SCHOOL_COL_CORRECT = portalPack().colCorrect;
  SCHOOL_VIEW_ANSWERS = portalPack().viewAnswers;
  SCHOOL_CHILDREN_COUNT = portalPack().childrenCount;
  SCHOOL_SUBJECTS_COUNT = portalPack().subjectsCount;
  SCHOOL_PHYSICAL_CLASSES_COUNT = portalPack().physicalClassesCount;
  SCHOOL_CLASS_STATUS_WITH_VALUE = portalPack().classStatusWithValue;
  SCHOOL_CREATE_CLASS_FAILED = portalPack().createClassFailed || portalPack().loadError;
  SCHOOL_CREATE_CHILD_FAILED = portalPack().createChildFailed || portalPack().loadError;
  SCHOOL_UPDATE_ASSIGNMENT_FAILED = portalPack().updateAssignmentFailed || portalPack().loadError;
  SCHOOL_LOAD_ASSIGNMENT_FAILED = portalPack().loadAssignmentFailed || portalPack().loadError;
  SCHOOL_INVITE_FAILED = portalPack().inviteFailed || portalPack().loadError;
  SCHOOL_CREATION_FAILED = portalPack().creationFailed || portalPack().loadError;
  SCHOOL_ACTION_FAILED = portalPack().actionFailed || portalPack().loadError;
...
export let SCHOOL_REPORT_LOAD_ERROR = "";
export let SCHOOL_MESSAGES_LOAD_ERROR = "";
export let SCHOOL_CHILDREN_LOAD_ERROR = "";
export let SCHOOL_PERMISSIONS_UPDATE_ERROR = "";
export let SCHOOL_PORTAL_LOAD_ERROR = "";
...
export let SCHOOL_NETWORK_ERROR = "";
export let SCHOOL_TEACHER_DETAIL_NETWORK_ERROR = "";
export let SCHOOL_NO_TEACHER_ID = "";
export let SCHOOL_NO_TEACHER_ID_IN_URL = "";
export let SCHOOL_AUTHORIZED_SUBJECTS = "";
export let SCHOOL_BACK_TO_ACTIVITIES = "";
export let SCHOOL_MONITOR_CHILDREN_QUESTIONS = "";
export let SCHOOL_CLASS_ACCURACY = "";
export let SCHOOL_COL_ANSWERS = "";
export let SCHOOL_COL_CORRECT = "";
export let SCHOOL_VIEW_ANSWERS = "";
export let SCHOOL_CHILDREN_COUNT = "";
export let SCHOOL_SUBJECTS_COUNT = "";
export let SCHOOL_PHYSICAL_CLASSES_COUNT = "";
export let SCHOOL_CLASS_STATUS_WITH_VALUE = "";
export let SCHOOL_CREATE_CLASS_FAILED = "";
export let SCHOOL_CREATE_CHILD_FAILED = "";
export let SCHOOL_UPDATE_ASSIGNMENT_FAILED = "";
export let SCHOOL_LOAD_ASSIGNMENT_FAILED = "";
export let SCHOOL_INVITE_FAILED = "";
export let SCHOOL_CREATION_FAILED = "";
export let SCHOOL_ACTION_FAILED = "";
...
/**
 * Fill `{name}` placeholders in school portal copy templates.
 * @param {string} template
 * @param {Record<string, string|number|null|undefined>} vars
 */
export function schoolUiFill(template, vars) {
