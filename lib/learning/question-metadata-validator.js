...
export const QUESTION_METADATA_SUBJECT_THRESHOLDS = Object.freeze({
  ...
  hebrew: {
    subject: "hebrew",
    phase: "Q2-C4",
    label: globalBurnDownCopy("lib__learning__question-metadata-validator", "hebrew"),
    minTotal: 50,
    minCoveragePct: 100,
    sampleKind: "bank+generator",
  },
  moledet: {
    ...
    phase: "Q2-C5",
    label: globalBurnDownCopy("lib__learning__question-metadata-validator", "moledet_geography"),
    minTotal: 3000,
    minCoveragePct: 100,
...
export async function collectSubjectCoverageSamples() {
  ...
  out.hebrew = { phase: "removed", total: 0, withCanonical: 0, samples: [] };
  out.moledet = { phase: "removed", total: 0, withCanonical: 0, samples: [] };
