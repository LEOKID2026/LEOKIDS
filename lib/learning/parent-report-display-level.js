 ...
 * Parent-facing: Regular / Advanced only. Internal sourceDifficulty stays in aggregate only.
 */
...
export const PARENT_FORBIDDEN_PRACTICE_LEVEL_HE = Object.freeze(["", "", ""]);
...
export function formatPracticeLevelLabelForParent(rawLevel, subjectId) {
  ...
  return displayLevelLabelHe(dl) || "Unavailable";
}
