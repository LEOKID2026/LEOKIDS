...
const LEVEL_LABELS = Object.freeze({ easy: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "regular"), medium: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "regular"), hard: "Advanced", mixed: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "regular"), regular: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "regular"), advanced: "Advanced" });

const MODE_LABELS = Object.freeze({
  learning: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "learning"),
  practice: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "practice"),
  challenge: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "challenge"),
  speed: "Speed",
  marathon: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "extended_practice"),
  graded: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "graded"),
  normal: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "regular"),
  mistakes: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "mistakes"),
  practice_mistakes: globalBurnDownCopy("lib__learning__report-visible-practice-sync", "review_mistakes"),
});

function modeLabelFromKey(modeKey) {
  if (modeKey == null || modeKey === "") return "Unavailable";
  return MODE_LABELS[modeKey] || String(modeKey);
}

function levelLabelFromKey(levelKey, subjectId) {
  if (levelKey == null || levelKey === "") return "Unavailable";
