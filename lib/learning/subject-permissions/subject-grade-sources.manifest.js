...
export const SUBJECT_GRADE_SOURCE_MANIFEST = [
  {
    subjectKey: "math",
    displayName: SUBJECT_PERMISSION_LABELS_HE.math,
    sortOrder: 1,
  ...
  {
    subjectKey: "geometry",
    displayName: SUBJECT_PERMISSION_LABELS_HE.geometry,
    sortOrder: 2,
  ...
  {
    subjectKey: "english",
    displayName: SUBJECT_PERMISSION_LABELS_HE.english,
    sortOrder: 3,
    primarySources: [
  ...
  {
    subjectKey: "science",
    displayName: SUBJECT_PERMISSION_LABELS_HE.science,
    sortOrder: 4,
    primarySources: [
