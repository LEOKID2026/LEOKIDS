...
function buildReferenceSheetBlocks(request, pageIdx) {
    ...
    return [
      {
        ...
        direction,
        textHe: writingUiT(locale)("worksheets.writingNoPracticeContent"),
      },
    ];
  }
  ...
  return [
    ...
    },
    {
      blockType: "instruction",
      direction,
      textHe: writingUiT(locale)("worksheets.writingTraceEachOnce"),
    },
    {
      blockType: "practice",
      direction,
...
export function buildReadyWritingPayload(entry, localeOpts = {}) {
  ...
  let titleHe = entry.titleHe;
  if (contentLocale && typeof entry.titleHe === "string") {
    titleHe = resolveReadyWritingTitle(entry.titleHe, contentLocale);
  }
