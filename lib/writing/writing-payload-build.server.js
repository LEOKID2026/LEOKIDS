...
export function buildWritingMeta(request, titleHeOverride) {
  ...
  const presetTitle =
    ...
    REFERENCE_SHEET_PRESETS[/** @type {keyof typeof REFERENCE_SHEET_PRESETS} */ (presetKey)]
      ...
      : null;
  return {
    titleHe: titleHeOverride || presetTitle || writingCategoryLabelEn(request.writingCategory) || writingUiT()("worksheets.writingPracticeFallbackTitle"),
    categoryHe: writingCategoryLabelEn(request.writingCategory) || "",
...
function buildReferenceSheetBlocks(request, pageIdx) {
    ...
    return [
      {
        ...
        direction,
        textHe: writingUiT()("worksheets.writingNoPracticeContent"),
      },
    ];
  }
  ...
  const presetTitle =
    typeof presetKey === "string" && REFERENCE_SHEET_PRESETS[/** @type {keyof typeof REFERENCE_SHEET_PRESETS} */ (presetKey)]
      ? REFERENCE_SHEET_PRESETS[/** @type {keyof typeof REFERENCE_SHEET_PRESETS} */ (presetKey)].titleHe
      : writingCategoryLabelEn(request.writingCategory) || writingUiT()("worksheets.writingPracticeFallbackTitle");
  ...
  return [
    ...
    },
    {
      blockType: "instruction",
      direction,
      textHe: writingUiT()("worksheets.writingTraceEachOnce"),
    },
    {
      blockType: "practice",
      direction,
  ...
  const blocks = [
    {
      blockType: "title",
      direction,
      textHe: writingCategoryLabelEn(request.writingCategory) || writingUiT()("worksheets.writingPracticeFallbackTitle"),
    },
    {
      blockType: "instruction",
      direction,
