...
/**
 * @param {Record<string, { titleEn?: string, title?: string }>} packs
 * @param {string} packId
 * @returns {string}
 */
...
/** Default locale-resolved packs (en). Prefer getWritingWordPacks(locale) for request locale. */
 ...
 */
export function getWritingWordPacks(contentLocale = "en") {
  return resolveWritingWordPacks(contentLocale || "en");
}
