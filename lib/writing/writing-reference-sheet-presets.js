...
/**
 * @typedef {Object} ReferenceSheetPresetBase
...
/**
 * @param {ReferenceSheetPresetBase} base
 */
function withLocalizedLabels(base) {
  return {
    ...base,
    /**
     * @param {string} [locale]
     */
    labelForLocale(locale = "en") {
     ...
     * @param {string} [locale]
     */
    titleForLocale(locale = "en") {
      const { t } = createTranslator(locale || "en");
      return t(base.titleKey);
    },
    get label() {
      return this.labelForLocale("en");
    },
    get title() {
      return this.titleForLocale("en");
    },
  };
}

/** @type {Record<ReferenceSheetPresetKey, ReturnType<typeof withLocalizedLabels>>} */
export const REFERENCE_SHEET_PRESETS = {
  en_upper: withLocalizedLabels({
    key: "en_upper",
    labelKey: "worksheets.writingRefPresetUpperLabel",
    titleKey: "worksheets.writingRefPresetUpperTitle",
  ...
  en_lower: withLocalizedLabels({
    key: "en_lower",
    labelKey: "worksheets.writingRefPresetLowerLabel",
    titleKey: "worksheets.writingRefPresetLowerTitle",
    writingCategory: "english_letters",
  ...
  digits: withLocalizedLabels({
    key: "digits",
    labelKey: "worksheets.writingRefPresetDigitsLabel",
    titleKey: "worksheets.writingRefPresetDigitsTitle",
