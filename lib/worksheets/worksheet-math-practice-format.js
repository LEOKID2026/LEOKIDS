...
export const WORKSHEET_MATH_PRACTICE_FORMATS = {
  horizontal_add_sub: {
    ...
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "horizontal_addition_and_subtraction"),
  ...
  vertical_add_sub: {
    id: "vertical_add_sub",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "vertical_addition_and_subtraction"),
    topicKeys: ["addition", "subtraction"],
    minGrade: 2,
    maxGrade: 6,
  ...
  basic_multiplication: {
    ...
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_multiplication"),
  ...
  long_multiplication: {
    ...
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_multiplication"),
    topicKeys: ["multiplication"],
    minGrade: 4,
    maxGrade: 6,
  ...
  basic_division: {
    id: "basic_division",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_division"),
    topicKeys: ["division"],
    minGrade: 2,
    maxGrade: 6,
    allowedKinds: ["div"],
  ...
  long_division: {
    id: "long_division",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_division"),
    topicKeys: ["division"],
    minGrade: 4,
    maxGrade: 6,
  ...
  fractions: {
    id: "fractions",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "fractions"),
    topicKeys: ["fractions"],
    minGrade: 2,
    maxGrade: 6,
    allowedKinds: [],
  ...
  decimals: {
    id: "decimals",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "decimals"),
    topicKeys: ["decimals"],
    minGrade: 3,
    maxGrade: 6,
    allowedKinds: [],
  ...
  percentages: {
    id: "percentages",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "percentages"),
  ...
  ratio_scale: {
    id: "ratio_scale",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "ratio_and_scale"),
  ...
  word_problems: {
    id: "word_problems",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "word_problems"),
  ...
  mixed: {
    id: "mixed",
    label: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "mixed_practice"),
    topicKeys: ["mixed"],
    minGrade: 1,
    maxGrade: 6,
    allowedKinds: [],
