...
export const WORKSHEET_MATH_PRACTICE_FORMATS = {
  horizontal_add_sub: {
    ...
    labelHe: "Horizontal addition and subtraction",
  ...
  vertical_add_sub: {
    id: "vertical_add_sub",
    labelHe: "Vertical addition and subtraction",
    topicKeys: ["addition", "subtraction"],
    minGrade: 2,
    maxGrade: 6,
