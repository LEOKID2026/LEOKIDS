...
export const WORKSHEET_MATH_PRACTICE_FORMATS = {
  horizontal_add_sub: {
    ...
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "horizontal_addition_and_subtraction"),
  ...
  vertical_add_sub: {
    id: "vertical_add_sub",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "vertical_addition_and_subtraction"),
    topicKeys: ["addition", "subtraction"],
    minGrade: 2,
    maxGrade: 6,
  ...
  basic_multiplication: {
    ...
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_multiplication"),
  ...
  long_multiplication: {
    ...
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_multiplication"),
    topicKeys: ["multiplication"],
    minGrade: 4,
    maxGrade: 6,
  ...
  basic_division: {
    id: "basic_division",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_division"),
    topicKeys: ["division"],
    minGrade: 2,
    maxGrade: 6,
    allowedKinds: ["div"],
  ...
  long_division: {
    id: "long_division",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_division"),
    topicKeys: ["division"],
    minGrade: 4,
    maxGrade: 6,
  ...
  fractions: {
    id: "fractions",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "fractions"),
    topicKeys: ["fractions"],
    minGrade: 2,
    maxGrade: 6,
    allowedKinds: [],
  ...
  decimals: {
    id: "decimals",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "decimals"),
    topicKeys: ["decimals"],
    minGrade: 3,
    maxGrade: 6,
    allowedKinds: [],
  ...
  percentages: {
    id: "percentages",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "percentages"),
    topicKeys: ["percentages"],
    minGrade: 5,
    maxGrade: 6,
    allowedKinds: ["perc_part_of", "perc_discount"],
    // Open by default — MCQ only if parent enabled multiple-choice.
    displayMode: "horizontal",
    preferOpen: true,
  },
  ratio_scale: {
    id: "ratio_scale",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "ratio_and_scale"),
  ...
  word_problems: {
    id: "word_problems",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "word_problems"),
    ...
    preferOpen: true,
    // Notebook-style writing lines inside a 2×2 card.
    writingSpaceLines: 4,
  },
  mixed: {
    id: "mixed",
    labelHe: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "mixed_practice"),
    topicKeys: ["mixed"],
    minGrade: 1,
    maxGrade: 6,
    allowedKinds: [],
...
const PRACTICE_FORMAT_LABEL_EN = {
  horizontal_add_sub: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "horizontal_addition_and_subtraction"),
  vertical_add_sub: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "vertical_addition_and_subtraction"),
  basic_multiplication: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_multiplication"),
  long_multiplication: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_multiplication"),
  basic_division: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_division"),
  long_division: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_division"),
  division_with_remainder: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_division"),
  long_division_with_remainder: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_division"),
  fractions: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "fractions"),
  decimals: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "decimals"),
  percentages: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "percentages"),
  ratio_scale: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "ratio_and_scale"),
  word_problems: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "word_problems"),
  mixed: globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "mixed_practice"),
};
...
export function mathPracticeFormatTitleEn(formatId, topicKey, gradeKey) {
  ...
  if (topic === "multiplication" && formatId === "basic_multiplication") return globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_multiplication");
  if (topic === "multiplication" && formatId === "long_multiplication") return globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_multiplication");
  if (topic === "division" && formatId === "basic_division") return globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_division");
  if (topic === "division" && formatId === "long_division") return globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_division");
  if (topic === "division_with_remainder" && formatId === "division_with_remainder") {
    return globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "basic_division");
  }
  if (topic === "division_with_remainder" && formatId === "long_division_with_remainder") {
    return globalBurnDownCopy("lib__worksheets__worksheet-math-practice-format", "long_division");
  }
