  ...
  generate(input) {
    ...
    if (typeof input?.slug === "string" && input.slug.trim()) {
      return generateReadyWritingBySlug(String(input.slug).trim(), {
        ...
        interfaceLocale: typeof input.interfaceLocale === "string" ? input.interfaceLocale : undefined,
        contentLocale: typeof input.contentLocale === "string" ? input.contentLocale : undefined,
        instructionLocale:
          typeof input.instructionLocale === "string" ? input.instructionLocale : undefined,
      });
    }
