...
export function worksheetPayloadToPreviewHtml(payload) {
  ...
  const header = `
    <header class="worksheet-header worksheet-header-centered">
      <div class="worksheet-header-top">
        ...
        <h1 class="worksheet-title">Worksheet</h1>
      </div>
  ...
  const renderQuestionArticle = (q, index = 0) => {
      ...
      const options =
        q.optionsHe?.length
          ? `<div class="worksheet-options-section"><p class="worksheet-options-heading">Options:</p><ol class="worksheet-options worksheet-options-grid">${q.optionsHe
              .map((o, i) => {
      ...
      const answerLine =
        ...
        (useMathPrintPages ||
          ...
          ? `<div class="worksheet-math-answer-line" aria-hidden="true"><span class="worksheet-math-answer-line-label">Answer:</span><span class="worksheet-math-answer-line-blank"></span></div>`
          : "";
      return `
      <article class="${cardClass}" data-index="${q.displayIndex}">
        <h2 class="worksheet-question-title">Question <span class="worksheet-question-number">${q.displayIndex}</span></h2>
...
export function answerKeyPayloadToPreviewHtml(payload) {
  ...
  const rows = answers
    .map((a) => {
      ...
      return `<li class="answer-key-item"><div class="answer-key-item-head">Answer <span class="worksheet-question-number">${a.displayIndex}</span></div>${bodyHtml}${
        a.explanationHe
...
<header class="worksheet-header worksheet-header-centered">
  <div class="worksheet-header-top">
    ...
    <h1 class="worksheet-title">Answer key</h1>
  </div>
  <p class="worksheet-meta">${escapeWorksheetHtml(meta.subjectHe)} · ${escapeWorksheetHtml(meta.gradeHe)} · ${escapeWorksheetHtml(meta.topicHe)} · ${escapeWorksheetHtml(meta.levelHe)}</p>
</header>
