...
/** @type {Record<WorksheetSubjectId, { label: string; enabled: boolean }>} */
export const WORKSHEET_SUBJECT_ALLOWLIST = {
  math: { label: "Math", enabled: true },
  geometry: { label: "Geometry", enabled: true },
  english: { label: "English", enabled: true },
};
