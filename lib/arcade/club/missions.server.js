...
const DEFAULT_MISSIONS = [
  { game_key: "fourline", description_he: "Play 3 games of Four in a Row", goal_type: "play", goal_count: 3, reward_coins: 50 },
  { game_key: "ludo", description_he: "Win twice at Ludo", goal_type: "win", goal_count: 2, reward_coins: 75 },
  { game_key: null, description_he: "Join a public room", goal_type: "join", goal_count: 1, reward_coins: 30 },
];
...
const DEFAULT_ACHIEVEMENTS = [
  {
    key: "first_game",
    name_he: gamePackCopy("lib__arcade__club__missions.server", "first_player"),
    description_he: gamePackCopy("lib__arcade__club__missions.server", "play_one_arcade_game"),
  ...
  },
  {
    key: "ten_wins",
    name_he: "10 wins",
    description_he: gamePackCopy("lib__arcade__club__missions.server", "win_10_times"),
    condition_type: "wins",
    condition_value: 10,
  },
  {
    key: "fifty_games",
    name_he: "50 games",
    description_he: gamePackCopy("lib__arcade__club__missions.server", "play_50_arcade_games"),
    condition_type: "games_played",
    condition_value: 50,
  },
];
