...
const DEFAULT_SAFE_MESSAGES = [
  { text_he: "Nice one!", emoji: "👏", category: "praise", min_permission_level: "guest" },
  { text_he: "Play again?", emoji: "🔄", category: "invite", min_permission_level: "guest" },
  { text_he: "Fun playing with you!", emoji: "😊", category: "fun", min_permission_level: "guest" },
  { text_he: "You won!", emoji: "🏆", category: "praise", min_permission_level: "registered" },
  { text_he: "Good game!", emoji: "⭐", category: "praise", min_permission_level: "registered" },
];
