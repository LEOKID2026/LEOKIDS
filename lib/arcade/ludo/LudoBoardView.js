...
/** Stable across renders — a fresh `|| {}` each call breaks deps and loops setState in useFinishFlash */
...
export default function LudoBoardView({
  ...
  /** When true — skip desktop square mode (like OV2); fill surface from the container */
