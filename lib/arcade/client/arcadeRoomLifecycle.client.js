...
export const ARCADE_ROOM_INACTIVE_MESSAGE = gamePackCopy("lib__arcade__client__arcadeRoomLifecycle.client", "the_game_has_ended");
export const ARCADE_ROOM_FORBIDDEN_MESSAGE = gamePackCopy("lib__arcade__client__arcadeRoomLifecycle.client", "room_is_no_longer_active");
