...
export const LEO_DOG_SPRITE_GALLERY = [
  ...
  { src: LEO_SPRITES.sittingCalm, label: "sitting-calm", note: "/ to" },
  { src: LEO_SPRITES.sitting, label: "sitting", note: "alt calm" },
  { src: LEO_SPRITES.superHappy, label: "super-happy", note: "/ All" },
  { src: LEO_SPRITES.playing, label: "playing", note: "to All" },
  { src: LEO_SPRITES.sleeping, label: "sleeping", note: "to All" },
  { src: LEO_SPRITES.dirty, label: "dirty", note: "to All" },
  { src: LEO_SPRITES.sleepingDirty, label: "sleeping-dirty", note: " + " },
];

/** Legacy card art — debug viewing only. */
export const LEO_DOG_CARD_GALLERY = [
  { src: "/images/card/shiba40.png", label: "shiba40", note: "legacy ·  " },
  { src: "/images/card/shiba45.png", label: "shiba45", note: "legacy ·  " },
  { src: "/images/card/shiba50.png", label: "shiba50", note: "legacy ·  " },
];
