...
export const MATH_CLASSIC = Object.freeze({
  ...
  hintBox: "bg-blue-500/10 border border-blue-400/50 rounded-lg p-3 text-start",
  hintTitle: "text-xs font-semibold text-blue-200/95 mb-1.5 tracking-tight",
  hintBody: "text-sm text-blue-100/95 leading-relaxed",
  errorBox: "bg-[#0a1222]/95 border border-rose-300/60 rounded-lg p-3 text-start shadow-xl backdrop-blur-sm",
