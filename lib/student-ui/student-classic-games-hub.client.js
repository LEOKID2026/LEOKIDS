...
export const GAMES_HUB_CLASSIC = Object.freeze({
  ...
  arcadeCoinBadge:
    "min-w-[4.75rem] rounded-lg border border-amber-300 bg-amber-100 px-2.5 py-1.5 text-start shadow-sm",
  arcadeDiamondBadge:
    "min-w-[4.75rem] rounded-lg border border-sky-300 bg-blue-50 px-2.5 py-1.5 text-start shadow-sm",
  ...
  arcadePanelOpenRooms:
    "rounded-xl border border-cyan-200 bg-cyan-50 p-4 shadow-sm text-start",
  arcadePanelJoinCode:
    "rounded-xl border border-amber-200 bg-amber-50 p-4 shadow-sm text-start",
  arcadePanelFriends:
    "rounded-xl border border-sky-200 bg-sky-50 p-4 shadow-sm text-start",
  arcadePanelShop:
    "rounded-xl border border-orange-200 bg-orange-50 p-4 shadow-sm text-start",
  arcadePanelProfile:
    "rounded-xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm text-start",
  arcadePanelMissions:
    "rounded-xl border border-teal-200 bg-teal-50 p-4 shadow-sm text-start",
  arcadePanelMyRoom:
    "rounded-xl border border-blue-200 bg-blue-50 p-4 shadow-sm text-start",
