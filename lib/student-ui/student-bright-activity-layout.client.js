...
export const STUDENT_ACTIVITY_LAYOUT_BRIGHT = {
  ...
  titleBlock: "min-w-0 flex-1 text-start",
  ...
  choiceButton:
    "w-full text-start px-3 py-2.5 rounded-xl border-2 min-h-[44px] disabled:opacity-60 disabled:cursor-not-allowed text-sm sm:text-base shadow-sm",
  ...
  mathToggle:
    "absolute top-1 start-1 z-10 px-2.5 py-1 rounded-lg text-xs font-bold bg-violet-500 hover:bg-violet-600 text-white transition-all pointer-events-auto shadow-md border border-violet-600",
