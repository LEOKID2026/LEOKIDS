...
export const SHARED_SHELL_CLASSIC = Object.freeze({
  ...
  body: "text-base sm:text-lg md:text-xl mb-4 text-white/90 text-start",
  bodyLast: "text-base sm:text-lg md:text-xl text-white/85 text-start",
  bodyCenter: "text-base sm:text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-4 text-start",
  bodyCenterMuted: "text-base sm:text-lg md:text-xl text-white/85 max-w-3xl mx-auto text-start",
  ...
  card: "bg-black/50 border border-white/10 p-6 rounded-xl shadow-md text-start",
  ...
  faqBtn:
    "px-4 py-3 bg-black/50 backdrop-blur-sm border border-white/15 rounded-xl text-amber-100 font-semibold text-sm sm:text-base text-start hover:bg-black/65 hover:border-amber-400/40 transition",
  ...
  faqModalInner: "relative bg-black/75 backdrop-blur-sm p-6 sm:p-8 min-h-[260px] flex flex-col text-start",
  ...
  tocDesktop: "hidden lg:block sticky top-20 self-start rounded-xl border border-white/10 bg-black/50 p-4 text-start",
  ...
  searchResult:
    "block rounded-xl border border-white/10 bg-black/50 p-4 hover:bg-black/65 transition text-start min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/70",
  searchResultTitle: "font-bold text-amber-100",
  searchResultSummary: "text-sm text-white/65 mt-1 line-clamp-2",
  searchEmpty: "text-white/60 text-sm text-start",
  ...
  disclaimer: "rounded-lg border border-white/14 bg-white/[0.06] px-4 py-4 text-start",
  ...
  screenshotError:
    "my-6 rounded-xl border border-amber-500/30 bg-black/50 p-4 text-amber-200/80 text-sm text-start",
  screenshotBorder: "w-full h-auto rounded-xl border border-white/10 shadow-lg",
  screenshotCaption: "mt-2 text-sm text-white/65",
  videoPreview:
    "group relative flex w-full max-w-xl mx-auto sm:mx-0 overflow-hidden rounded-xl border border-white/15 bg-black/60 text-start shadow-md transition hover:border-amber-400/40 hover:shadow-amber-900/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/70",
  videoPreviewLabel: "text-sm sm:text-base font-semibold text-white drop-shadow-md",
  videoDuration: "text-xs text-white/50 text-start",
  videoTranscript: "rounded-lg border border-white/10 bg-black/50 p-3 text-start",
  ...
  updatedAt: "mt-8 text-xs text-white/40 text-start",
});
