...
export const SHARED_SHELL_BRIGHT = Object.freeze({
  ...
  body: "text-base sm:text-lg md:text-xl mb-4 text-slate-700 text-start",
  bodyLast: "text-base sm:text-lg md:text-xl text-slate-600 text-start",
  bodyCenter: "text-base sm:text-lg md:text-xl text-slate-700 max-w-3xl mx-auto mb-4 text-start",
  bodyCenterMuted: "text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto text-start",
  ...
  card: "bg-white border border-sky-200 p-6 rounded-xl shadow-md shadow-sky-100/80 text-start",
  ...
  faqBtn:
    "px-4 py-3 bg-white border border-sky-200 rounded-xl text-slate-800 font-semibold text-sm sm:text-base text-start hover:bg-sky-50 hover:border-sky-400 transition shadow-sm",
  ...
  faqModalInner: "relative p-6 sm:p-8 min-h-[260px] flex flex-col text-start",
  ...
  tocDesktop:
    "hidden lg:block sticky top-20 self-start rounded-xl border border-sky-200 bg-white p-4 text-start shadow-sm",
  ...
  searchResult:
    "block rounded-xl border border-sky-200 bg-white p-4 hover:bg-sky-50 transition text-start min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/70 shadow-sm",
  searchResultTitle: "font-bold text-slate-800",
  searchResultSummary: "text-sm text-slate-600 mt-1 line-clamp-2",
  searchEmpty: "text-slate-500 text-sm text-start",
  ...
  disclaimer: "rounded-lg border border-sky-200 bg-sky-50/80 px-4 py-4 text-start",
  ...
  screenshotError:
    "my-6 rounded-xl border border-amber-300 bg-amber-50 p-4 text-amber-800 text-sm text-start",
  screenshotBorder: "w-full h-auto rounded-xl border border-sky-200 shadow-md",
  screenshotCaption: "mt-2 text-sm text-slate-600",
  videoPreview:
    "group relative flex w-full max-w-xl mx-auto sm:mx-0 overflow-hidden rounded-xl border border-sky-200 bg-white text-start shadow-md transition hover:border-sky-400 hover:shadow-sky-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70",
  videoPreviewLabel: "text-sm sm:text-base font-semibold text-slate-800 drop-shadow-sm",
  videoDuration: "text-xs text-slate-500 text-start",
  videoTranscript: "rounded-lg border border-sky-200 bg-white p-3 text-start shadow-sm",
  ...
  updatedAt: "mt-8 text-xs text-slate-500 text-start",
});
