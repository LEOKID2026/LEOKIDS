...
export const STUDENT_CLASSIC = Object.freeze({
  ...
  tile:
    "rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-4 md:p-5 text-start shadow-lg shadow-black/20 min-h-[6.75rem] md:min-h-[7.75rem] flex flex-col gap-2.5 overflow-hidden transition hover:border-emerald-400/35 hover:from-emerald-950/30 hover:to-white/[0.04]",
  ...
  panelIntro: "text-sm text-white/70 text-start mb-4 leading-relaxed",
  statsSummaryCard:
  ...
  monthlyTitle: "text-base md:text-lg font-bold text-white mb-3 text-start",
  ...
  subjectCard:
    "rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-4 flex flex-col text-start shadow-lg shadow-black/20 hover:border-emerald-400/30 transition overflow-hidden",
  ...
  activitySectionTitle: "text-base md:text-lg font-bold text-white mb-3 text-start",
  activityCard:
    "rounded-xl border border-white/10 bg-black/25 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-start shadow-sm hover:border-emerald-400/30 transition",
  ...
  worksheetSectionTitle: "text-base md:text-lg font-bold text-white mb-3 text-start",
  worksheetCard:
    "rounded-xl border border-white/10 bg-black/25 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-start shadow-sm hover:border-amber-400/25 transition",
  ...
  badgeSubject: "text-amber-200/60 text-xs me-1",

  recommendCard:
    "rounded-2xl border border-violet-400/25 bg-violet-950/20 p-4 md:p-5 text-start flex flex-col shadow-sm",
  ...
  emptyText: "text-white/65 text-start leading-relaxed",
  errorBox: "mt-4 rounded-2xl border border-amber-400/30 bg-amber-950/20 p-5 text-start space-y-3",
  ...
  buildErrorBox: "mt-4 rounded-2xl border border-rose-400/30 bg-rose-950/20 p-5 text-start",
  ...
  hubCardBase:
    "group rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-3 md:p-4 flex flex-col text-start min-h-[7rem] md:min-h-[7.5rem] shadow-sm overflow-hidden transition-colors duration-200 hover:border-emerald-400/35 hover:from-emerald-950/25 hover:to-white/[0.05] hover:shadow-md",
...
export const STUDENT_HOME_MODAL_CLASSIC = Object.freeze({
  ...
  title: "text-lg md:text-xl font-bold text-white text-start min-w-0",
  closeBtn:
...
export const STUDENT_HOME_MODAL_BRIGHT = Object.freeze({
  ...
  title: "text-lg md:text-xl font-bold text-slate-900 text-start min-w-0",
  closeBtn:
