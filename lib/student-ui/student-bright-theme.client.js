...
export const STUDENT_BRIGHT = Object.freeze({
  ...
  tile:
    "rounded-2xl border border-slate-300 bg-white p-4 md:p-5 text-start shadow-md hover:shadow-lg transition min-h-[6.75rem] md:min-h-[7.75rem] flex flex-col gap-2.5 overflow-hidden",
  ...
  panelIntro: "text-sm text-slate-700 text-start mb-4 leading-relaxed",
  statsSummaryCard:
  ...
  monthlyTitle: "text-base md:text-lg font-bold text-slate-800 mb-3 text-start",
  ...
  subjectCard:
    "rounded-2xl border border-slate-300 bg-white p-4 flex flex-col text-start shadow-md hover:border-teal-400 hover:shadow-lg transition overflow-hidden",
  ...
  activitySectionTitle: "text-base md:text-lg font-bold text-violet-900 mb-3 text-start",
  activityCard:
    "rounded-xl border border-slate-200 bg-white p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-start shadow-sm hover:border-violet-300 hover:shadow-md transition",
  ...
  worksheetSectionTitle: "text-base md:text-lg font-bold text-amber-900 mb-3 text-start",
  worksheetCard:
    "rounded-xl border border-slate-200 bg-white p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-start shadow-sm hover:border-amber-300 hover:shadow-md transition",
  ...
  badgeSubject: "text-amber-700/70 text-xs me-1",

  recommendCard:
    "rounded-2xl border border-violet-200 bg-violet-50/80 p-4 md:p-5 text-start flex flex-col shadow-sm",
  ...
  emptyText: "text-slate-600 text-start leading-relaxed",
  errorBox:
    "mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-start space-y-3",
  ...
  buildErrorBox: "mt-4 rounded-2xl border border-rose-200 bg-rose-50 p-5 text-start",
  ...
  hubCardBase:
    "group rounded-2xl border p-3 md:p-4 flex flex-col text-start min-h-[7rem] md:min-h-[7.5rem] bg-white shadow-sm overflow-hidden transition-colors duration-200 hover:shadow-md",
