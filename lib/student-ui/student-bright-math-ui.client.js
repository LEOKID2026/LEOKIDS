...
export const MATH_BRIGHT = Object.freeze({
  ...
  hintBox: "bg-blue-50 border border-blue-300 rounded-lg p-3 text-start shadow-sm",
  hintTitle: "text-xs font-bold text-blue-800 mb-1.5",
  hintBody: "text-sm text-blue-900 leading-relaxed",
  errorBox: "bg-rose-50 border border-rose-300 rounded-lg p-3 text-start shadow-sm",
