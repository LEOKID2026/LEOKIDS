...
/** @type {string} */
export const PLANNER_RECOMMENDED_PRACTICE_BUTTON_HE = burnDownCopy("lib__learning-client__adaptive-planner-recommended-practice", "continue_to_recommended_practice");
