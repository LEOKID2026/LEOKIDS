...
/** @type {string} */
export const PLANNER_AI_EXPLANATION_SECTION_LABEL_HE = burnDownCopy("lib__learning-client__adaptive-planner-explanation-validate", "how_the_next_practice_was_chosen");
