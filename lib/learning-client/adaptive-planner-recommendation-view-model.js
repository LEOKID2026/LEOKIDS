...
/** @type {string} */
export const PLANNER_UI_SECTION_TITLE = "Practice recommendation";

/** @type {string} */
export const PLANNER_UI_DIFFICULTY_LABEL = "Recommended practice level";

/** @type {string} */
export const PLANNER_UI_QUESTION_COUNT_LABEL = "Recommended number of questions";

/** Approved display copy only — maps planner `nextAction` (NEXT_ACTIONS). */
const FALLBACK_ACTION_HE = "Keep practicing based on your progress";
