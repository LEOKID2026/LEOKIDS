...
/** @type {string} */
export const PLANNER_UI_SECTION_TITLE = burnDownCopy("lib__learning-client__adaptive-planner-recommendation-view-model", "practice_recommendation");

/** @type {string} */
export const PLANNER_UI_DIFFICULTY_LABEL = burnDownCopy("lib__learning-client__adaptive-planner-recommendation-view-model", "recommended_practice_level");

/** @type {string} */
export const PLANNER_UI_QUESTION_COUNT_LABEL = burnDownCopy("lib__learning-client__adaptive-planner-recommendation-view-model", "recommended_number_of_questions");

/** Approved display copy only — maps planner `nextAction` (NEXT_ACTIONS). */
const FALLBACK_ACTION_HE = burnDownCopy("lib__learning-client__adaptive-planner-recommendation-view-model", "keep_practicing_based_on_your_progress");
...
export function mapPlannerNextActionToHebrew(nextAction) {
  ...
  if (n === "advance_skill") return "You're ready to move to the next step";
  if (n === "maintain_skill") return "Keep practicing at the same level";
  if (n === "practice_current") return "Strengthen the basics before moving on";
  if (n === "review_prerequisite") return "Do a short review";
  if (n === "probe_skill") return "Do a short review";
