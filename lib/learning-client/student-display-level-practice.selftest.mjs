...
const NON_SCIENCE = ["math", "geometry", "english", "history"];
...
// 3. Labels — no // in display labels
assert.equal(studentDisplayLevelLabel("regular"), "Regular");
assert.equal(studentDisplayLevelLabel("advanced"), "Advanced");
