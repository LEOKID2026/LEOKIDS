...
export const LOCALE_REGISTRY = Object.freeze({
  ...
  /**
   * Arabic master layer (UN M.49 region 001) — Modern Standard Arabic, country-neutral.
   * Future country locales inherit via fallbackLocale, e.g. ar-EG → ar-001 → en.
   * Path /ar-001 only — /ar is es-AR (Argentina).
   * OG: ar_SA verified via lib/seo/locale-seo.js resolveOgLocale consumer.
   * TTS: ar-SA verified via lib/speech/locale-resolver.js + speechSynthesis lang tag;
   * missing Arabic voice falls back to default utterance (no crash).
   */
  "ar-001": {
    id: "ar-001",
    enabled: true,
  ...
  /**
   * Arabic (Egypt) — sparse country overlay on ar-001.
   * Public path /eg (not /ar-EG). Chain: ar-EG → ar-001 → en.
  ...
  "ar-EG": {
    ...
    nativeName: "Egypt",
    intlLocale: "ar-EG",
    fallbackLocale: "ar-001",
    textToSpeechLocale: "ar-EG",
    ogLocale: "ar_EG",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * Arabic (Saudi Arabia) — sparse country overlay on ar-001.
   * Public path /sa (not /ar-SA). Chain: ar-SA → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-SA": {
    id: "ar-SA",
  ...
  /**
   * Arabic (Morocco) — sparse country overlay on ar-001.
   * Public path /ma (not /ar-MA). Chain: ar-MA → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-MA": {
    id: "ar-MA",
  ...
  /**
   * Arabic (Algeria) — sparse country overlay on ar-001.
   * Public path /dz (not /ar-DZ). Chain: ar-DZ → ar-001 → en.
   * No country-to-country Arabic inheritance.
   * Grade 6 display remains السنة 1 متوسط (not السنة 6).
   */
  "ar-DZ": {
    id: "ar-DZ",
    enabled: true,
  ...
  /**
   * Arabic (Iraq) — sparse country overlay on ar-001.
   * Public path /iq (not /ar-IQ). Chain: ar-IQ → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-IQ": {
    id: "ar-IQ",
  ...
  /**
   * Arabic (Jordan) — sparse country overlay on ar-001.
   * Public path /jo (not /ar-JO). Chain: ar-JO → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-JO": {
    id: "ar-JO",
  ...
  /**
   * Arabic (United Arab Emirates) — sparse country overlay on ar-001.
   * Public path /ae (not /ar-AE). Chain: ar-AE → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-AE": {
    id: "ar-AE",
    ...
    intlLocale: "ar-AE",
    fallbackLocale: "ar-001",
    textToSpeechLocale: "ar-AE",
    ogLocale: "ar_AE",
    aliases: ["United Arab Emirates", "Emirates", "الإمارات"],
    defaultMarket: "global",
    defaultCurriculum: "international",
    fonts: ["Noto Naskh Arabic", "Tahoma", "sans-serif"],
    label: "UAE",
  ...
  /**
   * Arabic (Tunisia) — sparse country overlay on ar-001.
   * Public path /tn (not /ar-TN). Chain: ar-TN → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-TN": {
    id: "ar-TN",
  ...
  /**
   * Arabic (Kuwait) — sparse country overlay on ar-001.
   * Public path /kw (not /ar-KW). Chain: ar-KW → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-KW": {
    id: "ar-KW",
  ...
  /**
   * Arabic (Qatar) — sparse country overlay on ar-001.
   * Public path /qa (not /ar-QA). Chain: ar-QA → ar-001 → en.
   * /qa is a product locale prefix; site-nav must not treat it as internal QA tooling.
   * No country-to-country Arabic inheritance.
   */
  "ar-QA": {
    id: "ar-QA",
  ...
  /**
   * Arabic (Oman) — sparse country overlay on ar-001.
   * Public path /om (not /ar-OM). Chain: ar-OM → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-OM": {
    id: "ar-OM",
  ...
  /**
   * Arabic (Bahrain) — sparse country overlay on ar-001.
   * Public path /bh (not /ar-BH). Chain: ar-BH → ar-001 → en.
   * No country-to-country Arabic inheritance.
   */
  "ar-BH": {
    id: "ar-BH",
  ...
  /**
   * Indonesian (Indonesia) — full language master. Public path /id (not /id-ID).
   * Bare `id` is not a registered alias (pathPrefix owns /id). Chain: id-ID → en.
   */
  "id-ID": {
    id: "id-ID",
    enabled: true,
   ...
   * Wales (en-WLS) inherits British-English Year/Maths chrome from en-GB.
   */
  "en-GB": {
    id: "en-GB",
    enabled: true,
  ...
  /**
   * Wales — sparse market overlay. Public /wls. Fallback: en-WLS → en-GB → en.
   * Year/Maths chrome inherits England (en-GB). Help inherits en-GB.
   */
  "en-WLS": {
    id: "en-WLS",
    enabled: true,
  ...
  /**
   * Philippines — sparse country overlay. Public /ph. Fallback: en-PH → en.
   * Help / word-meanings inherit en. Grades: Grade 1–6.
   */
  "en-PH": {
    id: "en-PH",
    enabled: true,
  ...
  /**
   * Jamaica — sparse country overlay. Public /jm. Fallback: en-JM → en.
   * Grades: Grade 1–6 (inherited). Caribbean Maths / spelling overlays.
   */
  "en-JM": {
    id: "en-JM",
    enabled: true,
  ...
  /**
   * Trinidad and Tobago — sparse country overlay. Public /tt. Fallback: en-TT → en.
   * Grades (display): Infant 2 → Standard 5 (g1–g6); national primary is Infant 1–Standard 5.
   */
  "en-TT": {
    id: "en-TT",
    enabled: true,
  ...
  /**
   * Bahamas — sparse country overlay. Public /bs. Fallback: en-BS → en.
   * Grades: Grade 1–6 (inherited). Caribbean Maths / spelling overlays.
   */
  "en-BS": {
    id: "en-BS",
  ...
  /**
   * Guyana — sparse country overlay. Public /gy. Fallback: en-GY → en.
   * Grades: Grade 1–6 (inherited). Caribbean Maths / spelling overlays.
   */
  "en-GY": {
    id: "en-GY",
  ...
  /**
   * English (Cameroon) — sparse country overlay.
   * Public path /cm-en. Bare /cm does not guess a language.
   * Chain: en-CM → en.
   */
  "en-CM": {
    id: "en-CM",
    ...
    nativeName: "Cameroon-en",
    intlLocale: "en-CM",
    fallbackLocale: "en",
    textToSpeechLocale: "en-CM",
    ogLocale: "en_CM",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * French (Benin) — sparse country overlay on fr-FR.
   * Public path /bj (not /fr-BJ).
  ...
  /**
   * English (Mauritius) — sparse country overlay.
   * Public path /mu-en. Bare /mu does not guess a language.
   * Chain: en-MU → en.
   */
  "en-MU": {
    id: "en-MU",
    ...
    nativeName: "Mauritius-en",
    intlLocale: "en-MU",
    fallbackLocale: "en",
    textToSpeechLocale: "en-MU",
    ogLocale: "en_MU",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * French (Guinea) — sparse country overlay on fr-FR.
   * Public path /gn (not /fr-GN).
  ...
  /**
   * French (Togo) — sparse country overlay on fr-FR.
   * Public path /tg (not /fr-TG).
  ...
  /**
   * French (Gabon) — sparse country overlay on fr-FR.
   * Public path /ga (not /fr-GA).
  ...
  /**
   * French (Congo) — sparse country overlay on fr-FR.
   * Public path /cg (not /fr-CG).
  ...
  /**
   * Dutch (Suriname) — sparse country overlay.
   * Public path /sr-nl (not /nl-SR). Bare /sr does not guess a language.
  ...
  "nl-SR": {
    ...
    nativeName: "Suriname-nl",
    intlLocale: "nl-SR",
    fallbackLocale: "nl-NL",
    textToSpeechLocale: "nl-SR",
    ogLocale: "nl_SR",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * Portuguese (Cabo Verde) — sparse country overlay.
   * Public path /cv-pt (not /pt-CV). Bare /cv does not guess a language.
  ...
  "pt-CV": {
    ...
    nativeName: "Cabo Verde-pt",
    intlLocale: "pt-CV",
    fallbackLocale: "pt-PT",
    textToSpeechLocale: "pt-CV",
    ogLocale: "pt_CV",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * Spanish (Equatorial Guinea) — sparse country overlay.
   * Public path /gq-es (not /es-GQ). Bare /gq does not guess a language.
  ...
  "es-GQ": {
    ...
    nativeName: "Equatorial Guinea-es",
    intlLocale: "es-GQ",
    fallbackLocale: "es-419",
    textToSpeechLocale: "es-GQ",
    ogLocale: "es_GQ",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * English (Sierra Leone) — sparse country overlay.
   * Public path /sl-en (not /en-SL). Bare /sl does not guess a language.
   * Chain: en-SL → en.
   */
  "en-SL": {
    id: "en-SL",
    ...
    nativeName: "Sierra Leone-en",
    intlLocale: "en-SL",
    fallbackLocale: "en",
    textToSpeechLocale: "en-SL",
    ogLocale: "en_SL",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
  ...
  /**
   * English (Liberia) — sparse country overlay.
   * Public path /lr (not /en-LR). Public path /lr.
   * Chain: en-LR → en.
   */
  "en-LR": {
    id: "en-LR",
  ...
  /**
   * English (The Gambia) — sparse country overlay.
   * Public path /gm (not /en-GM). Public path /gm.
   * Chain: en-GM → en.
   */
  "en-GM": {
    id: "en-GM",
    ...
    status: "enabled",
    direction: "ltr",
    displayName: "English (The Gambia)",
    nativeName: "The Gambia",
    intlLocale: "en-GM",
    fallbackLocale: "en",
    textToSpeechLocale: "en-GM",
    ogLocale: "en_GM",
    aliases: [],
    defaultMarket: "global",
    defaultCurriculum: "international",
...
/**
 * Locales shown in an active session picker — selectable list plus the current
 * locale when it is enabled but hidden from the global selector (e.g. ar-001).
 * Does not change registry selectorVisible or selectable count.
 *
 * @param {string|null|undefined} activeLocaleId
 */
export function getLocalePickerLocales(activeLocaleId) {
  const base = getSelectableLocales();
  const active = normalizeLocaleId(activeLocaleId);
  if (!active || active === DEFAULT_LOCALE) return base;
  if (base.some((l) => l.id === active)) return base;
  const def = LOCALE_REGISTRY[active];
  if (!def?.enabled || def.isPseudo) return base;
  return [def, ...base];
}
