...
export const LOCALE_REGISTRY = Object.freeze({
   ...
   * Future Portugal: pt-PT → pt-BR → en. Public path /br; selector label "Brasil".
   */
  "pt-BR": {
    id: "pt-BR",
    enabled: true,
  ...
  /**
   * England — en-GB serves England only for now (not United Kingdom umbrella).
   * Future Scotland/Wales/Northern Ireland may inherit British-English from en-GB later.
   */
  "en-GB": {
    id: "en-GB",
    enabled: true,
  ...
  // Note: bare `es` is intentionally absent as a locale id; Spain uses pathPrefix "es" → es-ES.
  // Bare `pt` is reserved for future Portugal (pt-PT); Brazil is pt-BR with pathPrefix "br".
  fr: mkDisabled("fr", "Français", "Français", "ltr", "fr-FR", "fr_FR"),
  de: mkDisabled("de", "Deutsch", "Deutsch", "ltr", "de-DE", "de_DE"),
  pt: mkDisabled("pt", "Português", "Português", "ltr", "pt-PT", "pt_PT"),
