...
export const STUDENT_ACTIVITY_LAYOUT = {
  ...
  choiceButton:
    "w-full text-start px-3 py-2.5 rounded-xl border min-h-[44px] disabled:opacity-60 disabled:cursor-not-allowed text-sm sm:text-base",
  ...
  mathToggle:
    "absolute top-1 start-1 z-10 px-2.5 py-1 rounded-lg text-xs font-bold bg-purple-500/80 hover:bg-purple-500 text-white transition-all pointer-events-auto shadow-lg",
