...
function userFacingActivityLevelLabel(levelKeyOrLabel, subjectId, levelsMap) {
  ...
  if (raw === "רגיל" || raw === globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "standard") || raw === "regular" || raw === "Easy" || raw === globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "medium")) {
    return globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "standard");
  }
  if (raw === "מתקדם" || raw === globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "advanced") || raw === "advanced" || raw === "Hard") {
  ...
  if (legacyName === "קשה" || legacyName === "Hard") return globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "advanced");
  if (
    legacyName === "קל" ||
    legacyName === "בינוני" ||
    legacyName === "רגיל" ||
  ...
  if (legacyName === "מתקדם" || legacyName === globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "advanced")) return globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "advanced");
  return globalBurnDownCopy("lib__classroom-activities__generate-activity-questions-client", "standard");
}
