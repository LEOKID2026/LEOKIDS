...
const TEXT_SUBJECTS = new Set(["english"]);
...
function mathOperationFromTopic(topic) {
  ...
  if (t.includes("fraction") || t.includes("")) return "fractions";
  if (t.includes("mult") || t.includes("")) return "multiplication";
  if (t.includes("div") || t.includes("")) return "division";
  if (t.includes("sub") || t.includes("")) return "subtraction";
  if (t.includes("add") || t.includes("")) return "addition";
  return "addition";
}
