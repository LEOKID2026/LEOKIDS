...
import { getLearningBookSubjectLabelCopy, bookUiCopyForLocale } from "./book-pack-copy.js";
 ...
 * @param {string} subject
 */
export function getLearningBookSubjectLabel(subject, contentLocale = "en") {
  return getLearningBookSubjectLabelCopy(subject, contentLocale);
}

/** @deprecated Use getLearningBookSubjectLabel */
export function getLearningBookSubjectLabelHe(subject, contentLocale = "en") {
  return getLearningBookSubjectLabel(subject, contentLocale);
}
...
export const LEARNING_BOOK_META_BY_KEY = (() => {
  ...
  map[getLearningBookKey("math", "g1")] = {
    ...
    grade: "g1",
    status: "authored",
    meta: { ...MATH_G1_BOOK_META, subjectTitle: "Math" },
  };
  map[getLearningBookKey("math", "g2")] = {
    subject: "math",
    grade: "g2",
    status: "authored",
    meta: { ...MATH_G2_BOOK_META, subjectTitle: "Math" },
  };
  map[getLearningBookKey("math", "g3")] = {
    subject: "math",
    grade: "g3",
    status: "authored",
    meta: { ...MATH_G3_BOOK_META, subjectTitle: "Math" },
  };
  map[getLearningBookKey("math", "g4")] = {
    subject: "math",
    grade: "g4",
    status: "authored",
    meta: { ...MATH_G4_BOOK_META, subjectTitle: "Math" },
  };
  map[getLearningBookKey("math", "g5")] = {
    subject: "math",
    grade: "g5",
    status: "authored",
    meta: { ...MATH_G5_BOOK_META, subjectTitle: "Math" },
  };
  map[getLearningBookKey("math", "g6")] = {
    subject: "math",
    grade: "g6",
    status: "authored",
    meta: { ...MATH_G6_BOOK_META, subjectTitle: "Math" },
  };
  ...
  map[getLearningBookKey("geometry", "g1")] = {
    ...
    grade: "g1",
    status: "authored",
    meta: { ...GEOMETRY_G1_BOOK_META, subjectTitle: "Geometry" },
  };
  ...
  map[getLearningBookKey("geometry", "g2")] = {
    ...
    grade: "g2",
    status: "authored",
    meta: { ...GEOMETRY_G2_BOOK_META, subjectTitle: "Geometry" },
  };
  ...
  map[getLearningBookKey("geometry", "g3")] = {
    ...
    grade: "g3",
    status: "authored",
    meta: { ...GEOMETRY_G3_BOOK_META, subjectTitle: "Geometry" },
  };
  ...
  map[getLearningBookKey("geometry", "g4")] = {
    ...
    grade: "g4",
    status: "authored",
    meta: { ...GEOMETRY_G4_BOOK_META, subjectTitle: "Geometry" },
  };
  ...
  map[getLearningBookKey("geometry", "g5")] = {
    ...
    grade: "g5",
    status: "authored",
    meta: { ...GEOMETRY_G5_BOOK_META, subjectTitle: "Geometry" },
  };
  ...
  map[getLearningBookKey("geometry", "g6")] = {
    ...
    grade: "g6",
    status: "authored",
    meta: { ...GEOMETRY_G6_BOOK_META, subjectTitle: "Geometry" },
  };
  ...
  map[getLearningBookKey("science", "g1")] = {
    ...
    grade: "g1",
    status: "authored",
    meta: { ...SCIENCE_G1_BOOK_META, subjectTitle: "Science" },
  };
  ...
  map[getLearningBookKey("science", "g2")] = {
    ...
    grade: "g2",
    status: "authored",
    meta: { ...SCIENCE_G2_BOOK_META, subjectTitle: "Science" },
  };
  ...
  map[getLearningBookKey("science", "g3")] = {
    ...
    grade: "g3",
    status: "authored",
    meta: { ...SCIENCE_G3_BOOK_META, subjectTitle: "Science" },
  };
  ...
  map[getLearningBookKey("science", "g4")] = {
    ...
    grade: "g4",
    status: "authored",
    meta: { ...SCIENCE_G4_BOOK_META, subjectTitle: "Science" },
  };
  ...
  map[getLearningBookKey("science", "g5")] = {
    ...
    grade: "g5",
    status: "authored",
    meta: { ...SCIENCE_G5_BOOK_META, subjectTitle: "Science" },
  };
  ...
  map[getLearningBookKey("science", "g6")] = {
    ...
    grade: "g6",
    status: "authored",
    meta: { ...SCIENCE_G6_BOOK_META, subjectTitle: "Science" },
  };
  ...
  map[getLearningBookKey("english", "g1")] = {
    ...
    grade: "g1",
    status: "authored",
    meta: { ...ENGLISH_G1_BOOK_META, subjectTitle: "English" },
  };
  ...
  map[getLearningBookKey("english", "g2")] = {
    ...
    grade: "g2",
    status: "authored",
    meta: { ...ENGLISH_G2_BOOK_META, subjectTitle: "English" },
  };
  ...
  map[getLearningBookKey("english", "g3")] = {
    ...
    grade: "g3",
    status: "authored",
    meta: { ...ENGLISH_G3_BOOK_META, subjectTitle: "English" },
  };
  ...
  map[getLearningBookKey("english", "g4")] = {
    ...
    grade: "g4",
    status: "authored",
    meta: { ...ENGLISH_G4_BOOK_META, subjectTitle: "English" },
  };
  ...
  map[getLearningBookKey("english", "g5")] = {
    ...
    grade: "g5",
    status: "authored",
    meta: { ...ENGLISH_G5_BOOK_META, subjectTitle: "English" },
  };
  ...
  map[getLearningBookKey("english", "g6")] = {
    ...
    grade: "g6",
    status: "authored",
    meta: { ...ENGLISH_G6_BOOK_META, subjectTitle: "English" },
  };
 ...
 */
export function getLearningBookTileTitle(subject, grade, contentLocale = "en") {
  const subjectLabel = getLearningBookSubjectLabel(subject, contentLocale);
  const template = bookUiCopyForLocale(contentLocale, "tile", "titleTemplate") || "{subject} Book";
  const line1 = template.replace("{subject}", subjectLabel);
  return {
    line1,
    line2: getGradeShortLabel(grade, contentLocale),
  };
}
