...
/** @typedef {{ id: string, titleKey: string, pages: string[] }} ScienceG6Batch */

/** @type {ScienceG6Batch[]} */
const SCIENCE_G6_BOOK_BATCHES_RAW = [
  { id: "a", titleKey: "science.g6.a", pages: ["body", "animals"] },
  {
    id: "b",
    titleKey: "science.g6.b",
    pages: ["materials", "earth_space", "environment"],
  },
  { id: "c", titleKey: "science.g6.c", pages: ["experiments"] },
];
...
export const SCIENCE_G6_BOOK_META = Object.freeze({
  ...
  bookTitleKey: "science.g6.bookTitle",
