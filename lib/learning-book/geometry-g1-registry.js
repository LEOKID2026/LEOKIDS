...
const GEOMETRY_G1_BOOK_BATCHES_RAW = [
  {
    id: "a",
    title: "Getting to Know the Square [DRAFT and more", titleHe: "Getting to Know the Square [DRAFT and more",
    pages: ["shapes_basic_square", "shapes_basic_rectangle"],
  },
  {
    id: "b",
    title: "Translation and Reflection — Introduction [DRAFT — not owner-approved]", titleHe: "Translation and Reflection — Introduction [DRAFT — not owner-approved]",
...
export const GEOMETRY_G1_BOOK_META = Object.freeze({
  ...
  bookTitle: "Geometry — Grade 1", bookTitleHe: "Geometry — Grade 1",
