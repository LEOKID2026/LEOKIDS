...
export const BOOK_GRADE_THEMES = Object.freeze({
  ...
  g1: gradeTheme("g1", "", BOOK_GRADE_ACCENT_HEX.g1, {
  ...
  // G2 — sky blue / water
  g2: gradeTheme("g2", "", BOOK_GRADE_ACCENT_HEX.g2, {
  ...
  // G3 — peach / mango
  g3: gradeTheme("g3", "", BOOK_GRADE_ACCENT_HEX.g3, {
  ...
  // G4 — sunny gold
  g4: gradeTheme("g4", "", BOOK_GRADE_ACCENT_HEX.g4, {
  ...
  g5: gradeTheme("g5", "", BOOK_GRADE_ACCENT_HEX.g5, {
  ...
  // G6 — lilac / space
  g6: gradeTheme("g6", "", BOOK_GRADE_ACCENT_HEX.g6, {
