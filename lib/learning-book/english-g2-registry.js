...
/** @typedef {{ id: string, titleKey: string, pages: string[] }} EnglishG2Batch */

/** @type {EnglishG2Batch[]} */
const ENGLISH_G2_BOOK_BATCHES_RAW = [
  {
    id: "phonics-review",
    titleKey: "english.g2.phonics-review",
    pages: [
      "letters_review",
      "letters_order",
...
export const ENGLISH_G2_BOOK_META = Object.freeze({
  ...
  bookTitleKey: "english.g2.bookTitle",
