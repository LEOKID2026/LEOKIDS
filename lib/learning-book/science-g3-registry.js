...
/** @typedef {{ id: string, titleKey: string, pages: string[] }} ScienceG3Batch */

/** @type {ScienceG3Batch[]} */
const SCIENCE_G3_BOOK_BATCHES_RAW = [
  {
    id: "a",
    titleKey: "science.g3.a",
    pages: ["body", "animals", "plants"],
  },
  {
    id: "b",
    titleKey: "science.g3.b",
    pages: ["materials", "earth_space", "environment"],
  },
  { id: "c", titleKey: "science.g3.c", pages: ["experiments"] },
];
...
export const SCIENCE_G3_BOOK_META = Object.freeze({
  ...
  bookTitleKey: "science.g3.bookTitle",
