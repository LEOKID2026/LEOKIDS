...
const SCIENCE_G4_BOOK_BATCHES_RAW = [
  ...
  { id: "c", title: "Planning an Experiment [DRAFT — not owner-approved]", titleHe: "Planning an Experiment [DRAFT — not owner-approved]", pages: ["experiments"] },
];
...
export const SCIENCE_G4_BOOK_META = Object.freeze({
  ...
  bookTitle: "Science — Grade 4", bookTitleHe: "Science — Grade 4",
