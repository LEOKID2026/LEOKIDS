...
/** @typedef {{ id: string, titleKey: string, pages: string[] }} EnglishG5Batch */

/** @type {EnglishG5Batch[]} */
const ENGLISH_G5_BOOK_BATCHES_RAW = [
  {
    "id": "a",
    "titleKey": "english.g5.a",
    "pages": [
      "vocab_animals",
      "vocab_community",
      "vocab_emotions",
...
export const ENGLISH_G5_BOOK_META = Object.freeze({
  ...
  bookTitleKey: "english.g5.bookTitle",
