...
const MATH_G1_BOOK_BATCHES_RAW = [
  {
    id: "a",
    title: "Counting Forward on the Number Line and more", titleHe: "Counting Forward on the Number Line and more",
    pages: [
      "ns_counting_forward",
  ...
  {
    id: "b",
    title: "Tens and Ones and more", titleHe: "Tens and Ones and more",
    pages: [
      "ns_place_tens_units",
      "ns_even_odd",
      "ns_complement10",
...
export const MATH_G1_BOOK_META = Object.freeze({
  ...
  bookTitle: "Math — Grade 1", bookTitleHe: "Math — Grade 1",
