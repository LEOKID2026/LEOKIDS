 ...
 *
 * English/science/geometry/math books: flat sequential page MP3s or section-level paths (legacy generation scripts).
...
/** @deprecated */
export const HEBREW_G1_SECTION_AUDIO_PILOT = null;
...
/** Default cache version (English G1). */
export const LEARNING_BOOK_AUDIO_CACHE_VERSION = ENGLISH_G1_FLAT_PAGE_AUDIO.cacheVersion;
