...
/** @typedef {{ id: string, titleKey: string, pages: string[] }} GeometryG4Batch */

/** @type {GeometryG4Batch[]} */
const GEOMETRY_G4_BOOK_BATCHES_RAW = [
  {
    id: "a",
    titleKey: "geometry.g4.a",
    pages: [
  ...
  {
    id: "b",
    titleKey: "geometry.g4.b",
    pages: ["quadrilaterals", "parallel_perpendicular"],
  },
  {
    id: "c",
    titleKey: "geometry.g4.c",
    pages: [
      "square_perimeter",
      "square_area",
      "triangle_perimeter",
  ...
  {
    id: "d",
    titleKey: "geometry.g4.d",
    pages: ["diagonal_square", "diagonal_rectangle"],
  },
  {
    id: "e",
    titleKey: "geometry.g4.e",
...
export const GEOMETRY_G4_BOOK_META = Object.freeze({
  ...
  bookTitleKey: "geometry.g4.bookTitle",
