...
/** @typedef {{ id: string, titleKey: string, pages: string[] }} ScienceG2Batch */

/** @type {ScienceG2Batch[]} */
const SCIENCE_G2_BOOK_BATCHES_RAW = [
  {
    id: "a",
    titleKey: "science.g2.a",
    pages: ["body", "animals", "plants"],
  },
  {
    id: "b",
    titleKey: "science.g2.b",
    pages: ["materials", "earth_space", "environment"],
  },
  { id: "c", titleKey: "science.g2.c", pages: ["experiments"] },
];
...
export const SCIENCE_G2_BOOK_META = Object.freeze({
  ...
  bookTitleKey: "science.g2.bookTitle",
