...
function isPlausibleDisplayLabel(label) {
  ...
  if (/[=+−×÷]/.test(plain.replace(/(?!)/u, ""))) return false;
  // Clock times / ratios ( 2:, 1:25) — not structural RTL labels.
...
/**
 * True when a digit starts a step label like " 4:" - not a math expression.
