...
export const SOLO_DIFFICULTY_OPTIONS = Object.freeze([
  {
    id: "easy",
    get label() {
      return gamePackCopy("lib__solo-games__solo-game-registry", "difficulty_easy");
    },
  },
  {
    id: "medium",
    get label() {
      return gamePackCopy("lib__solo-games__solo-game-registry", "difficulty_medium");
    },
  },
  {
    id: "hard",
    get label() {
      return gamePackCopy("lib__solo-games__solo-game-registry", "difficulty_hard");
    },
  },
]);
...
/** @type {Record<string, { id: string, route: string, title: string, emoji: string, blurb: string, hasDifficultyPicker: boolean, orientationHint: SoloOrientationHint, help: SoloGameHelpConfig }>} */
export const SOLO_GAME_REGISTRY = {
  catcher: {
    id: "catcher",
    route: "/student/solo-games/catcher",
    title: gamePackCopy("lib__solo-games__solo-game-registry", "catch_with_leo"),
    emoji: "🎯",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "catch_coins_and_stay_away_from_bombs"),
  ...
  flyer: {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "leo_in_a_plane"),
    emoji: "🪂",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "hold_to_fly_collect_coins_and_avoid_obstacles"),
    hasDifficultyPicker: false,
    orientationHint: "landscape-recommend",
    help: {
  ...
  puzzle: {
    ...
    title: "Leo's Puzzle",
    emoji: "🧩",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "merge_tiles_and_rack_up_points_before_time_runs_out"),
  ...
  memory: {
    ...
    title: "Leo's Memory Game",
    emoji: "🧠",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "flip_cards_and_find_pairs_before_the_clock_runs_out"),
    hasDifficultyPicker: true,
  ...
  "leo-jump": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "leo_jumps"),
    emoji: "🦘",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "jump_over_obstacles_and_collect_coins"),
    hasDifficultyPicker: false,
    orientationHint: "landscape-recommend",
    help: {
  ...
  balloons: {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "balloon_pop"),
    emoji: "🎈",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "pop_balloons_before_time_runs_out"),
    hasDifficultyPicker: false,
    orientationHint: null,
    help: {
  ...
  maze: {
    ...
    title: "Leo's Maze",
    emoji: "🌀",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "find_the_exit_of_the_maze_before_time_runs_out"),
    hasDifficultyPicker: true,
    orientationHint: "portrait-recommend",
    help: {
  ...
  "picture-puzzle": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "picture_puzzle"),
    emoji: "🖼️",
    blurb: "Complete the pieces of Leo's picture!",
    hasDifficultyPicker: true,
    orientationHint: "landscape-recommend",
    help: {
  ...
  "target-tap": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "target_tap"),
    emoji: "🎯",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "tap_the_targets_before_they_disappear"),
    hasDifficultyPicker: true,
    orientationHint: null,
    help: {
  ...
  "sort-shapes": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "sort_shapes"),
    emoji: "🔺",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "sort_shapes_and_colors_into_the_correct_boxes"),
    hasDifficultyPicker: true,
    orientationHint: null,
    help: {
  ...
  "smart-blocks": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "smart_blocks"),
    emoji: "🧱",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "place_shapes_clear_rows_and_columns_and_reach_the_score_target"),
    hasDifficultyPicker: true,
    orientationHint: "landscape-recommend",
    help: {
  ...
  "fruit-slice": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "fruit_slice"),
    emoji: "🍎",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "slice_fruit_avoid_bombs_and_reach_the_score_target"),
    hasDifficultyPicker: true,
    orientationHint: null,
    help: {
  ...
  "leo-miners": {
    ...
    title: gamePackCopy("lib__solo-games__solo-game-registry", "leo_the_miner"),
    emoji: "⛏️",
    blurb: gamePackCopy("lib__solo-games__solo-game-registry", "merge_mining_dogs_break_rocks_and_earn_points_to_redeem"),
    hasDifficultyPicker: false,
    orientationHint: "portrait-recommend",
    help: {
      howToPlay:
