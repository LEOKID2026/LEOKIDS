...
export const SMART_BLOCKS_SHAPE_LIBRARY = [
  ...
  {
    id: "pair-h",
    labelHe: gamePackCopy("lib__solo-games__smart-blocks-shapes", "horizontal_pair"),
    cells: [
      [0, 0],
      [0, 1],
    ],
  ...
  {
    id: "pair-v",
    labelHe: gamePackCopy("lib__solo-games__smart-blocks-shapes", "vertical_pair"),
    cells: [
      [0, 0],
      [1, 0],
    ],
  ...
  {
    id: "line-3",
    labelHe: gamePackCopy("lib__solo-games__smart-blocks-shapes", "horizontal_line_of_3"),
    cells: [
      [0, 0],
      [0, 1],
      [0, 2],
  ...
  {
    id: "line-3-v",
    labelHe: gamePackCopy("lib__solo-games__smart-blocks-shapes", "vertical_line_of_3"),
    cells: [
      [0, 0],
      [1, 0],
      [2, 0],
  ...
  {
    id: "line-4",
    labelHe: gamePackCopy("lib__solo-games__smart-blocks-shapes", "horizontal_line_of_4"),
    cells: [
      [0, 0],
      [0, 1],
      [0, 2],
  ...
  {
    id: "line-4-v",
    labelHe: gamePackCopy("lib__solo-games__smart-blocks-shapes", "vertical_line_of_4"),
    cells: [
      [0, 0],
      [1, 0],
      [2, 0],
