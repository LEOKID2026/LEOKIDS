...
export const STUDENT_MANIFEST_HREF = "/api/pwa/manifest?portal=student";
export const PARENT_MANIFEST_HREF = "/api/pwa/manifest?portal=parent";
export const TEACHER_MANIFEST_HREF = "/api/pwa/manifest?portal=teacher";
