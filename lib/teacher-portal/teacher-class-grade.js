...
const GRADE_KEY_TO_EN = {
  g1: globalBurnDownCopy("lib__teacher-portal__teacher-class-grade", "grade_1"),
  g2: globalBurnDownCopy("lib__teacher-portal__teacher-class-grade", "grade_2"),
  g3: globalBurnDownCopy("lib__teacher-portal__teacher-class-grade", "grade_3"),
  g4: globalBurnDownCopy("lib__teacher-portal__teacher-class-grade", "grade_4"),
  g5: globalBurnDownCopy("lib__teacher-portal__teacher-class-grade", "grade_5"),
  g6: globalBurnDownCopy("lib__teacher-portal__teacher-class-grade", "grade_6"),
};

/**
 * English grade label for teacher portal UI (live EN surface).
...
export function formatGradeLevelHe(gradeLevel) {
  ...
  if (canonical && GRADE_KEY_TO_EN[canonical]) return GRADE_KEY_TO_EN[canonical];
