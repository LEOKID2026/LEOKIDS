...
const SCIENCE_TOPIC_LABELS = {
  body: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "human_body"),
  animals: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "animals"),
  plants: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "plants"),
  materials: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "materials"),
  experiments: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "experiments"),
  earth_space: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "earth_space"),
  environment: globalBurnDownCopy("lib__teacher-portal__teacher-class-topic-options", "environment"),
};
