...
export const VB_ASPECT_RATIOS = {
  "16:9": { label: "16:9 - Wide", w: 16, h: 9, previewClass: "aspect-video" },
  "9:16": { label: "9:16 - Story", w: 9, h: 16, previewClass: "aspect-[9/16]", safeZone: true },
  "1:1": { label: "1:1 - Square", w: 1, h: 1, previewClass: "aspect-square" },
  "4:5": { label: "4:5 - Feed", w: 4, h: 5, previewClass: "aspect-[4/5]", safeZone: true },
  "4:3": { label: "4:3 - Classic", w: 4, h: 3, previewClass: "aspect-[4/3]" },
};
...
export const VB_MEDIA_FITS = {
  contain: { label: "Fit - with background" },
  cover: { label: "Cover - no background" },
};
...
export const VB_TRANSITIONS = {
  ...
  fade_black: { label: "Fade to black", xfade: "fadeblack", duration: 0.6 },
  slide_left: { label: "Slide left", xfade: "slideleft", duration: 0.5 },
  wipe_right: { label: "Wipe right", xfade: "wiperight", duration: 0.5 },
};

/** @type {Record<string, { label: string, previewClass?: string, ffmpegBox?: string }>} */
export const VB_TEXT_BACKGROUNDS = {
  none: { label: "None" },
  soft: { label: "Soft background", previewClass: "vb-text-bg-soft", ffmpegBox: "black@0.35" },
  solid: { label: "Solid background", previewClass: "vb-text-bg-solid", ffmpegBox: "black@0.65" },
...
export const VB_WATERMARK_POSITIONS = {
  top_right: { label: "Top right", overlay: "W-w-40:40" },
  top_left: { label: "Top left", overlay: "40:40" },
  bottom_right: { label: "Bottom right", overlay: "W-w-40:H-h-40" },
  bottom_left: { label: "Bottom left", overlay: "40:H-h-40" },
};

export const VB_EXPORT_QUALITIES = {
  "720p": { label: "720p (fast)", scale: 720 },
  "1080p": { label: "1080p (quality)", scale: 1080 },
};
...
export const VB_SCENE_TEMPLATES = [
    ...
    scenes: [
      {
        ...
        subtitle: "Learning with a smile",
        durationSec: 4,
  ...
  },
  {
    ...
    scenes: [
      {
        title: "Did you know?",
        subtitle: "3 tips for fun learning",
        durationSec: 3,
  ...
  },
  {
    ...
    scenes: [
      {
        title: "Smart progress report",
        subtitle: "See your child truly progressing",
        durationSec: 5,
      ...
      },
      {
        ...
        subtitle: "Activities, learning time, recommendations",
        durationSec: 5,
        bgType: "light",
        animation: "slide_up",
        titleColor: "#0f172a",
...
export const VB_ANIMATIONS = {
  none: { label: "None", previewClass: "", exportKind: "none" },
  fade: { label: "Fade - appear", previewClass: "animate-vb-fade-in", exportKind: "fade" },
  zoom: { label: "Zoom - light zoom", previewClass: "animate-vb-zoom-in", exportKind: "zoom" },
  slide_up: { label: "Slide - from bottom", previewClass: "animate-vb-slide-up", exportKind: "fade" },
  slide_down: { label: "Slide - from top", previewClass: "animate-vb-slide-down", exportKind: "fade" },
  slide_left: { label: "Slide - from right", previewClass: "animate-vb-slide-right", exportKind: "fade" },
  slide_right: { label: "Slide - from left", previewClass: "animate-vb-slide-left", exportKind: "fade" },
  blur_in: { label: "Blur - blur in", previewClass: "animate-vb-blur-in", exportKind: "fade" },
  scale_pop: { label: "Pop - pop", previewClass: "animate-vb-scale-pop", exportKind: "scale_pop" },
  pulse: { label: "Pulse - pulse", previewClass: "animate-vb-pulse", exportKind: "fade" },
  ken_burns: { label: "Ken Burns - motion", previewClass: "animate-vb-ken-burns", exportKind: "ken_burns" },
};

export const VB_TEXT_SIZES = {
  sm: { label: "Small", titlePx: 40, subtitlePx: 26, previewTitle: "text-base sm:text-lg", previewSubtitle: "text-xs sm:text-sm" },
  md: { label: "Medium", titlePx: 56, subtitlePx: 36, previewTitle: "text-lg sm:text-2xl", previewSubtitle: "text-sm sm:text-base" },
  lg: { label: "Large", titlePx: 72, subtitlePx: 48, previewTitle: "text-xl sm:text-3xl", previewSubtitle: "text-base sm:text-lg" },
  xl: { label: "Extra large", titlePx: 96, subtitlePx: 56, previewTitle: "text-2xl sm:text-4xl", previewSubtitle: "text-lg sm:text-xl" },
};

export const VB_TEXT_SHADOWS = {
  none: { label: "None", previewClass: "", borderw: 0, borderAlpha: 0 },
  soft: { label: "Soft", previewClass: "drop-shadow-md", borderw: 2, borderAlpha: 0.35 },
  strong: { label: "Strong", previewClass: "drop-shadow-lg", borderw: 3, borderAlpha: 0.55 },
};

export const VB_MEDIA_OVERLAYS = {
  none: { label: "None", previewClass: "", ffmpegBox: null },
  dim: { label: "Light dim", previewClass: "vb-overlay-dim", ffmpegBox: "black@0.3" },
  dark: { label: "Strong dim", previewClass: "vb-overlay-dark", ffmpegBox: "black@0.55" },
  light: { label: "Lighten", previewClass: "vb-overlay-light", ffmpegBox: "white@0.25" },
};
...
export const VB_TEXT_COLOR_PRESETS = [
  ...
  { id: "slate", label: "Dark gray", hex: "#334155" },
