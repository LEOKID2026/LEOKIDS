...
export const EDUCATIONAL_GAME_KEYS_ARCHIVED = Object.freeze(["leo-word-detective"]);
...
export const EDUCATIONAL_GAME_REGISTRY = Object.freeze({
  ...
  "leo-word-detective": {
    ...
    blurbHe: "Not available on LeoKids Global (Hebrew reading practice).",
    emoji: "🕵️",
    route: "/student/educational-games/leo-word-detective",
    hubRoute: "/student/educational-games",
    hasDifficultyPicker: true,
    availableInGlobal: false,
    help: {
      howToPlay:
