...
export const EDUCATIONAL_GAME_REGISTRY = Object.freeze({
  "recycling-factory": {
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "sort_trash_into_the_right_bins_and_help_protect_the_environment"),
    emoji: "♻️",
  ...
  "leo-gifts": {
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "equal_division_remainders_and_quick_math"),
    emoji: "🍬",
  ...
  "leo-bakery": {
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "multiplication_equal_groups_and_trays"),
    emoji: "🥐",
  ...
  "leo-number-path": {
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "sequences_odd_even_and_multiples"),
    emoji: "🔢",
  ...
  "leo-pizzeria": {
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "learning_fractions_through_making_pizzas"),
    emoji: "🍕",
    ...
    help: {
      ...
      rewards: "Coins are awarded based on how many customers you served, accuracy, streaks, and difficulty level - even if you didn't serve all 20 customers.",
      tip: gamePackCopy("lib__educational-games__educational-game-registry", "check_how_many_slices_each_topping_covers_half_quarter_and_eighth_refer_"),
    },
  },
  "leo-word-train": {
    id: "leo-word-train",
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "letters_words_and_sentences_in_english_riding_on_the_train_cars"),
    emoji: "🚂",
  ...
  "leo-word-detective": {
    ...
    blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "drag_evidence_onto_the_board_and_solve_reading_and_vocabulary_cases"),
    emoji: "🕵️",
...
export const EDUCATIONAL_HUB = Object.freeze({
  ...
  blurbHe: gamePackCopy("lib__educational-games__educational-game-registry", "enrichment_games_critical_thinking_and_general_knowledge"),
  emoji: "📚",
});
