...
export function getTeacherPortalTheme(isBright) {
  if (isBright) {
    return {
      ...
      emptyInput:
        "mt-1 w-full rounded-lg bg-white border border-slate-300 px-3 py-2 text-sm text-start shadow-sm",
  ...
  return {
    ...
    emptyInput:
      "mt-1 w-full rounded-lg bg-black/40 border border-white/20 px-3 py-2 text-sm text-start",
