...
export function worksheetStatusLabelHe(status) {
  const map = {
    draft: globalBurnDownCopy("lib__worksheet-activities__worksheet-labels.client", "draft"),
...
export function worksheetModeLabelHe(mode) {
  const map = {
    pdf_only: globalBurnDownCopy("lib__worksheet-activities__worksheet-labels.client", "pdf_only"),
