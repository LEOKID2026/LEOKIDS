 ...
 * Same aggregate as student " " / monthly persistence.
 */
...
export async function attachUnifiedCreditedLearningTimeToParentReportPayload(
  ...
  summary.learningTimeTimezone = burnDownCopy("lib__parent-server__attach-unified-learning-time.server", "asia_jerusalem");

  const meta =
    payload.meta && typeof payload.meta === "object" ? { ...payload.meta } : {};
  meta.learningTimeSource = "unified_credited";
  meta.learningTimeTimezone = burnDownCopy("lib__parent-server__attach-unified-learning-time.server", "asia_jerusalem");
