...
export function getPipelineErrorMessageHe(err) {
  ...
  const msg = {
    coloringUploadQuotaUser: t("worksheets.coloringUploadQuotaUser"),
    coloringUploadPayloadTooLarge: t("worksheets.coloringUploadPayloadTooLarge"),
    coloringUploadEngineFailed: t("worksheets.coloringUploadEngineFailed"),
    coloringUploadBadResult: t("worksheets.coloringUploadBadResult"),
    coloringUploadStyleTransferTimeout: t("worksheets.coloringUploadStyleTransferTimeout"),
    coloringUploadStyleTransferFailed: t("worksheets.coloringUploadStyleTransferFailed"),
    coloringUploadStyleTransferUnavailable: t("worksheets.coloringUploadStyleTransferUnavailable"),
    coloringUploadStyleTransferRateLimited: t("worksheets.coloringUploadStyleTransferRateLimited"),
    coloringUploadProcessFailed: t("worksheets.coloringUploadProcessFailed"),
  };
  if (err instanceof DOMException && err.name === "AbortError") return "";
  if (err instanceof Error) {
    if (err.name === "ColoringUploadQuotaError") {
      return /** @type {any} */ (err).message || msg.coloringUploadQuotaUser;
    }
