 ...
 */
function uiPackIndexFor(contentLocale) {
  return resolveRegisteredContentPack(contentLocale, "games", "ui-pack-index.json") || {};
}
...
export function loadGameUiPackClient(gameKey, contentLocale) {
  ...
  const uiPackIndex = uiPackIndexFor(localeId);
