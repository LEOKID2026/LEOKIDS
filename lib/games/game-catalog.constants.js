...
export const GAME_ACCESS_MESSAGES = Object.freeze({
  admin_disabled: globalBurnDownCopy("lib__games__game-catalog.constants", "this_game_is_not_available_right_now"),
  parent_locked: globalBurnDownCopy("lib__games__game-catalog.constants", "locked_by_parents"),
});
