...
export function formatRegularReportTopicTimeCellHe(row) {
  ...
  if (q <= 0) {
    return reportPackCopy("lib__parent-ui__parent-report-regular-time", "zero_minutes");
  }
  return reportPackCopy("lib__parent-ui__parent-report-regular-time", "minutes_short", {
    m: String(tm),
  });
}
