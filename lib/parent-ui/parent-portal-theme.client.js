...
export function getParentPortalTheme(isBright) {
  if (isBright) {
    return {
      ...
      infoBox:
        "mb-3 rounded-lg border border-sky-200 bg-sky-50/90 px-3.5 py-3 space-y-2 text-start shadow-sm",
      ...
      modalTitle: "text-lg md:text-xl font-bold text-slate-900 text-start min-w-0",
      modalClose:
      ...
      permissionsTitle: "text-sm font-semibold text-slate-900 text-start",
      permissionsHint: "text-xs text-slate-500 text-start",
      permissionsRow:
        "flex items-center justify-between gap-3 rounded-lg border border-slate-200 bg-white px-3 py-2",
      permissionsLabel: "text-sm text-slate-800 text-start flex-1",
      gateBox: "rounded-xl border border-amber-200 bg-amber-50 p-5 sm:p-6 space-y-4 text-start",
      ...
      guardianBox: "rounded-xl border border-amber-200 bg-amber-50 p-4 text-start space-y-3",
      guardianText: "text-sm text-amber-900",
      guardianBtn:
        "w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm hover:bg-sky-50 disabled:opacity-50 text-start text-slate-800",
    };
  }
  ...
  return {
    ...
    infoBox: "mb-3 rounded-lg border border-white/10 bg-white/5 px-3.5 py-3 space-y-2 text-start",
    ...
    modalTitle: "text-lg md:text-xl font-bold text-white text-start min-w-0",
    modalClose:
    ...
    permissionsTitle: "text-sm font-semibold text-white text-start",
    permissionsHint: "text-xs text-white/50 text-start",
    permissionsRow:
      "flex items-center justify-between gap-3 rounded-lg border border-white/10 bg-black/20 px-3 py-2",
    permissionsLabel: "text-sm text-white text-start flex-1",
    gateBox: "rounded-xl border border-amber-400/35 bg-black/50 p-5 sm:p-6 space-y-4 text-start",
    ...
    guardianBox: "rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-start space-y-3",
    guardianText: "text-sm text-amber-100",
    guardianBtn:
      "w-full rounded-lg border border-white/20 bg-black/30 px-4 py-2 text-sm hover:bg-white/10 disabled:opacity-50 text-start text-white",
  };
}
