...
export const STUDENT_TRUTH_LABELS_HE = Object.freeze({
  noData: burnDownCopy("lib__learning-shared__student-display-truth", "no_data_yet"),
  unavailable: burnDownCopy("lib__learning-shared__student-display-truth", "data_unavailable_right_now"),
  loading: burnDownCopy("lib__learning-shared__student-display-truth", "loading"),
  cumulative: burnDownCopy("lib__learning-shared__student-display-truth", "cumulative"),
  periodThisMonth: burnDownCopy("lib__learning-shared__student-display-truth", "for_the_current_month"),
  periodLifetime: burnDownCopy("lib__learning-shared__student-display-truth", "cumulative_from_all_sessions"),
  completedSessionsOnly: burnDownCopy("lib__learning-shared__student-display-truth", "from_completed_sessions"),
  allSessionsWithDuration: burnDownCopy("lib__learning-shared__student-display-truth", "from_all_sessions_with_duration"),
  creditedLearningMinutes: burnDownCopy("lib__learning-shared__student-display-truth", "credited_learning_time_questions_books_and_parent_activities"),
});
...
export function classifyChallengeProgressPct(meta, progressPct) {
  if (meta?.reconciled) {
    return {
      ...
      displayHe: progressPct != null ? `${progressPct}% (estimated)` : STUDENT_TRUTH_LABELS_HE.noData,
    };
  }
