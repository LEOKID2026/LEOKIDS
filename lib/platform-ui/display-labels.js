...
import { resolveApiErrorMessage } from "../api/resolve-api-error-message.js";
...
/**
 * Code-first API error display (legacy name retained).
 * Prefers validation.api[code] over English error.message prose.
 *
