          ...
          <div className="flex items-center justify-center gap-1 sm:gap-2 max-w-full min-w-0">
            ...
            >
              <button
                ...
                type="button"
                onClick={onClose}
                className="absolute -top-2 -start-2 z-20 inline-flex items-center justify-center rounded-lg border border-white/20 bg-black/35 text-[#FFE8A3] text-2xl leading-none min-h-11 min-w-11 hover:bg-black/50 transition"
                style={{ direction: "ltr" }}
