...
export function getPublicSeoWideClasses(isBright) {
  ...
  const body = isBright ? "text-start text-slate-600" : "text-start text-white/75";
  const muted = isBright ? "text-start text-slate-500" : "text-start text-white/60";
  ...
  return {
    ...
    section: isBright
      ? "rounded-2xl border border-slate-200/80 bg-white/80 p-5 text-start shadow-md md:p-7"
      : "rounded-2xl border border-white/10 bg-white/5 p-5 text-start shadow-lg shadow-black/20 md:p-7",
    sectionTitle: isBright
      ? "text-start text-2xl font-black text-sky-900 md:text-3xl"
      : "text-start text-2xl font-black text-sky-100 md:text-3xl",
    sectionSubtitle: isBright
      ? "text-start text-lg font-bold text-sky-900 md:text-xl"
      : "text-start text-lg font-bold text-sky-100 md:text-xl",
    highlight: isBright
      ? "rounded-2xl border border-sky-200 bg-sky-50/80 p-5 text-start md:p-6"
      : "rounded-2xl border border-cyan-400/30 bg-cyan-500/10 p-5 text-start md:p-6",
    footerCta: isBright
    ...
    hubCard: isBright
      ? "block rounded-2xl border border-sky-100 bg-gradient-to-br from-white via-sky-50/80 to-violet-50/40 p-4 text-start shadow-md transition hover:border-sky-200 hover:shadow-lg"
      : "block rounded-2xl border border-white/10 bg-white/5 p-4 text-start transition hover:bg-white/10",
    hubCardTitle: isBright ? "font-bold text-sky-900" : "font-bold text-white",
    hubCardBlurb: isBright ? "mt-1 text-start text-sm text-slate-600" : "mt-1 text-start text-sm text-white/70",
    linkSky: isBright
    ...
    bulletRow: isBright
      ? "flex items-start gap-3 rounded-xl border border-sky-100/90 bg-white/85 px-4 py-3 text-start shadow-sm"
      : "flex items-start gap-3 rounded-xl border border-white/15 bg-white/10 px-4 py-3 text-start",
    bulletIcon: isBright
    ...
    interactiveSlot: isBright
      ? "rounded-2xl border border-sky-200/80 bg-white/90 p-4 text-start shadow-md md:p-6"
      : "rounded-2xl border border-white/10 bg-white/5 p-4 text-start md:p-6",
  };
}
...
export function getPublicSeoInnerPanelClass(isBright, variant = "sky") {
  if (isBright) {
    const map = {
      sky: "rounded-2xl border-2 border-sky-200/90 bg-gradient-to-br from-sky-100/90 via-white to-cyan-100/75 p-5 text-start shadow-lg shadow-sky-200/50 ring-1 ring-sky-100 md:p-6",
      violet:
        "rounded-2xl border-2 border-violet-200/90 bg-gradient-to-br from-violet-100/85 via-white to-sky-100/70 p-5 text-start shadow-lg shadow-violet-200/40 ring-1 ring-violet-100 md:p-6",
      emerald:
        "rounded-2xl border-2 border-emerald-200/90 bg-gradient-to-br from-emerald-100/80 via-white to-teal-100/70 p-5 text-start shadow-lg shadow-emerald-200/40 ring-1 ring-emerald-100 md:p-6",
      amber:
        "rounded-2xl border-2 border-amber-200/90 bg-gradient-to-br from-amber-100/90 via-white to-orange-50/80 p-5 text-start shadow-lg shadow-amber-200/45 ring-1 ring-amber-100 md:p-6",
    };
    return map[variant];
  }

  const map = {
    sky: "rounded-2xl border-2 border-cyan-400/35 bg-gradient-to-br from-cyan-500/25 via-sky-900/20 to-violet-900/15 p-5 text-start shadow-xl shadow-black/25 md:p-6",
    violet:
      "rounded-2xl border-2 border-violet-400/35 bg-gradient-to-br from-violet-500/25 via-indigo-900/20 to-fuchsia-900/15 p-5 text-start shadow-xl shadow-black/25 md:p-6",
    emerald:
      "rounded-2xl border-2 border-emerald-400/35 bg-gradient-to-br from-emerald-500/20 via-teal-900/15 to-cyan-900/15 p-5 text-start shadow-xl shadow-black/25 md:p-6",
    amber:
      "rounded-2xl border-2 border-amber-400/35 bg-gradient-to-br from-amber-500/25 via-orange-900/15 to-yellow-900/10 p-5 text-start shadow-xl shadow-black/25 md:p-6",
  };
  return map[variant];
}
