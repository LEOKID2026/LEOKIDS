# Grade 2 English Learning Book — Hebrew Review Pack
...
>
> **Draft coverage:** Grade 2 English has **15 / 15** draft pages authored. Source: `docs/learning-book/english/g2/drafts/`.
>
...
|--------|-------|
| **Total pages** | 15 |
| **Batch A** (אוצר מילים — חזרה מעמיקה (כיתה א׳)) | 7 |
| **Batch B** (אוצר מילים חדש — מזון ובית) | 2 |
| **Batch C** (דקדוק בסיסי — be, ריבוי, שאלות) | 2 |
| **Batch D** (משפטים ותרגום) | 4 |
...
## Page 11: grammar_plural_questions.md
...
## Page 14: translation_classroom.md
...
## Page 15: translation_routines.md
