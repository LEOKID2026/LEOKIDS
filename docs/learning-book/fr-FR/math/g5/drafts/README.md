# Livre d'apprentissage des mathématiques de CM2 — Brouillons

**Statut :** Tous les lots créés – **40/40** brouillons de pages terminés (lots A à H). Examen du propriétaire en attente.  
**Date :** juin 2026  
**Dossier :** `docs/learning-book/math/g5/drafts/`
...
| Document / file | Role |
|-----------------|------|
| `data/curriculum-spine/v1/skills.json` | All 40 CM2 Math `skill_id` entries in scope |
...
| `utils/math-constants.js` | CM2 operations context only |
...
## Lot F — גורמים, כפולות, מ.א.ח ואומדן (6)
...
- `book_placeholder.md` — espace réservé à l'infrastructure ; **ne** fait pas partie du livre de 40 pages.
...
- Des milliers groupés (`1,000`, `10,000`, `48,726`) apparaissent dans de nombreuses pages — le moteur de rendu doit isoler LTR.

---

## Régénérer les brouillons/réviser le pack
