...
Сегодня мы будем учиться the difference between Simple and Continuous.
...
Попробуй сам.
На следующей странице мы вместе проверим ответ и как к нему прийти.
...
"They" — множественное число — мы используем are + playing.
