# Groep 6 Math Learning Book — Drafts
...
| Document / file | Role |
|-----------------|------|
| `data/curriculum-spine/v1/skills.json` | All 37 Groep 6 Math `skill_id` entries in scope |
...
| `utils/math-constants.js` | Groep 6 operations context only |
