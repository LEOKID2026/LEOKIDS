# Groep 7 Math Learning Book — Drafts
...
| Document / file | Role |
|-----------------|------|
| `data/curriculum-spine/v1/skills.json` | All 40 Groep 7 Math `skill_id` entries in scope |
...
| `utils/math-constants.js` | Groep 7 operations context only |
