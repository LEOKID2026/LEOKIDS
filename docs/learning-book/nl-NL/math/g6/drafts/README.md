# Groep 8 Math Learning Book — Drafts
...
| Document / file | Role |
|-----------------|------|
| `data/curriculum-spine/v1/skills.json` | All 44 Groep 8 Math `skill_id` entries in scope |
...
| `utils/math-constants.js` | Groep 8 operations context only |
...
- Groep 7 fraction/percent skills (`frac_add_sub`, `frac_reduce`, etc.) are **not** in G6 spine scope — assumed covered in G5 book.
