# Groep 5 Math Learning Book — Drafts
...
| Document / file | Role |
|-----------------|------|
| `data/curriculum-spine/v1/skills.json` | All 26 Groep 5 Math `skill_id` entries in scope |
...
| `utils/math-constants.js` | Groep 5 operations context |
