...
export default async function handler(req, res) {
  ...
  try {
    const result = await applyDominoesAction(auth.supabase, {
      roomId,
      studentId: auth.studentId,
      action,
      tileId: body.tileId != null ? Number(body.tileId) : null,
      side: body.side != null ? String(body.side) : null,
    ...
    console.error("[api/arcade/games/dominoes/action] unexpected error", err);
