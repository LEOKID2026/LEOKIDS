...
const WORKSHEET_UI_KEYS = [
  ...
  "writingFontSizeLg",
  "writingFontSizeXl",
  "writingPrintStrengthLight",
  "writingPrintStrengthNormal",
  "writingPrintStrengthStrong",
  "writingTraceRenderFull",
  "writingTraceRenderFaint",
  "writingTraceRenderOutline",
  "writingTraceRenderStrokePath",
  "writingReferenceSheetField",
  "writingReferenceSheetManual",
  "writingNumberMin",
  "writingNumberMax",
  "writingLettersPerRow",
  "writingLetterSize",
  "writingPrintStrength",
  "writingOrientationPortrait",
  "writingOrientationLandscape",
  "writingTraceDisplayStyle",
