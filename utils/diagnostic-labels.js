...
/** Legacy *He export names — Global product uses English labels. */
...
export const weaknessLabelHe = weaknessLabelEn;
export const sessionRowLabelHe = sessionRowLabelEn;
export const parentFacingWeaknessPracticePhraseHe = parentFacingWeaknessPracticePhraseEn;
export const topicBucketLabelHe = topicBucketLabel;
