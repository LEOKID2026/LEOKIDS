...
import { buildEngineDecisionParentTopicCopyHe, buildExplainIdentifiedLineHe, PARENT_TECHNICAL_ID_STRIP_RE } from "./parent-report-language/engine-decision-parent-copy.js";
import {
...
const CONF_BADGE_HE = {
  high: reportPackCopy("utils__parent-report-ui-explain", "enough_questions_in_this_period"),
  medium: "A moderate number of questions in this period",
  low: reportPackCopy("utils__parent-report-ui-explain", "still_limited_data_a_bit_more_practice_will_help_us_understand_better"),
};

const SUFF_BADGE_HE = {
  high: reportPackCopy("utils__parent-report-ui-explain", "amount_of_practice_good"),
  medium: reportPackCopy("utils__parent-report-ui-explain", "amount_of_practice_moderate"),
  low: reportPackCopy("utils__parent-report-ui-explain", "amount_of_practice_low"),
};

const RISK_FLAG_HE = {
  falsePromotionRisk: reportPackCopy("utils__parent-report-ui-explain", "risk_of_moving_up_a_level_too_early"),
  falseRemediationRisk: reportPackCopy("utils__parent-report-ui-explain", "risk_of_over_treating"),
  speedOnlyRisk: reportPackCopy("utils__parent-report-ui-explain", "tendency_toward_speed"),
  hintDependenceRisk: reportPackCopy("utils__parent-report-ui-explain", "the_child_still_relies_on_hints"),
  insufficientEvidenceRisk: reportPackCopy("utils__parent-report-ui-explain", "only_partial_information"),
  recentTransitionRisk: "A small recent change",
};

const TREND_DIR_HE = {
  up: reportPackCopy("utils__parent-report-ui-explain", "improving"),
  down: reportPackCopy("utils__parent-report-ui-explain", "declining"),
  flat: reportPackCopy("utils__parent-report-ui-explain", "no_change"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_enough"),
};
...
export function shortReportDiagnosticsParentVisibleHe(s) {
  ...
  return normalizeParentFacing(stripKnownParentReportLeakageHe(t));
}
...
export function trendCompactLineHe(trend) {
  ...
  if (sumRaw) {
    ...
    s = s.replace(/\s{2,}/g, " ").trim();
    return truncateHe(normalizeParentFacing(s), 100);
  }
...
export const INTERVENTION_TYPE_LABEL_HE = {
  stabilize_accuracy: reportPackCopy("utils__parent-report-ui-explain", "reinforce_accuracy_before_changing_level"),
  reduce_time_pressure: reportPackCopy("utils__parent-report-ui-explain", "ease_time_pressure_a_bit_while_keeping_accuracy"),
  guided_to_independent_transition: reportPackCopy("utils__parent-report-ui-explain", "move_slowly_from_guided_support_to_independence"),
  clarify_instruction_pattern: reportPackCopy("utils__parent-report-ui-explain", "explain_the_task_and_break_it_into_small_steps"),
...
export const LEARNING_STAGE_LABEL_HE = {
  early_acquisition: reportPackCopy("utils__parent-report-ui-explain", "still_learning_and_experimenting_this_topic_is_relatively_new"),
  partial_stabilization: reportPackCopy("utils__parent-report-ui-explain", "starting_to_stabilize_not_fully_there_yet"),
  stable_control: reportPackCopy("utils__parent-report-ui-explain", "good_problem_solving_that_holds_over_time"),
  fragile_retention: reportPackCopy("utils__parent-report-ui-explain", "the_material_is_retained_with_difficulty"),
  regression_signal: "A recent decline - worth watching over the coming week",
  transfer_emerging: reportPackCopy("utils__parent-report-ui-explain", "starting_to_apply_outside_of_the_exact_practice_format_too"),
  insufficient_longitudinal_evidence: reportPackCopy("utils__parent-report-ui-explain", "still_not_enough_information_over_time"),
};

const PHASE8_DURATION_BAND_HE = {
  very_short: reportPackCopy("utils__parent-report-ui-explain", "very_short_sessions"),
  short: reportPackCopy("utils__parent-report-ui-explain", "short_sessions"),
  moderate: reportPackCopy("utils__parent-report-ui-explain", "moderate_length_sessions"),
};

const PHASE8_INTENSITY_HE = {
  light: "Light",
  focused: reportPackCopy("utils__parent-report-ui-explain", "focused"),
  targeted: reportPackCopy("utils__parent-report-ui-explain", "precise"),
};

const PHASE8_FORMAT_HE = {
  guided_practice: reportPackCopy("utils__parent-report-ui-explain", "guided_practice"),
  independent_practice: reportPackCopy("utils__parent-report-ui-explain", "independent_practice"),
  mixed: reportPackCopy("utils__parent-report-ui-explain", "guided_and_independent"),
  observation_block: reportPackCopy("utils__parent-report-ui-explain", "observation_and_measurement"),
};

const PHASE8_PARENT_EFFORT_HE = {
  low: reportPackCopy("utils__parent-report-ui-explain", "light_parent_involvement"),
  medium: reportPackCopy("utils__parent-report-ui-explain", "moderate_parent_involvement"),
  high: reportPackCopy("utils__parent-report-ui-explain", "high_parent_involvement"),
};

const PHASE8_PRACTICE_LOAD_HE = {
  minimal: reportPackCopy("utils__parent-report-ui-explain", "minimal_practice"),
  light: reportPackCopy("utils__parent-report-ui-explain", "light_practice"),
  moderate: reportPackCopy("utils__parent-report-ui-explain", "moderate_practice"),
};
...
export const RESPONSE_TO_INTERVENTION_LABEL_HE = {
  ...
  early_positive_response: reportPackCopy("utils__parent-report-ui-explain", "there_are_early_signs_of_improvement_not_confirmed_yet"),
  stalled_response: reportPackCopy("utils__parent-report-ui-explain", "progress_feels_stalled_worth_refining_or_changing_direction_a_bit"),
  over_supported_progress: reportPackCopy("utils__parent-report-ui-explain", "success_mostly_happens_with_help_nearby_not_yet_full_independence"),
  independence_growing: reportPackCopy("utils__parent-report-ui-explain", "independence_is_growing_alongside_progress"),
  regression_under_support: "A negative trend even with the same support",
  mixed_response: reportPackCopy("utils__parent-report-ui-explain", "mixed_response_some_progress_some_still_dependent"),
};

export const SUPPORT_FIT_LABEL_HE = {
  good_fit: reportPackCopy("utils__parent-report-ui-explain", "good_fit_with_current_support"),
  partial_fit: reportPackCopy("utils__parent-report-ui-explain", "partial_fit_keep_tracking_and_adjusting"),
  poor_fit: reportPackCopy("utils__parent-report-ui-explain", "weak_fit_consider_changing_approach"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_yet_clear_whether_the_fit_is_good"),
};

export const SUPPORT_ADJUSTMENT_NEED_LABEL_HE = {
  hold_course: reportPackCopy("utils__parent-report-ui-explain", "continue_in_the_same_direction_carefully"),
  tighten_focus: reportPackCopy("utils__parent-report-ui-explain", "narrow_to_one_goal_and_slow_down_a_bit"),
  reduce_support: reportPackCopy("utils__parent-report-ui-explain", "gradually_reduce_support_as_independence_appears"),
  increase_structure: reportPackCopy("utils__parent-report-ui-explain", "add_a_short_clear_structure"),
  change_strategy: "Change approach - what we tried isn't enough",
  monitor_only: reportPackCopy("utils__parent-report-ui-explain", "observe_and_gather_more_information_before_deciding"),
};

/** Phase 10 — freshness of the conclusion */
export const FRESHNESS_STATE_LABEL_HE = {
  fresh: reportPackCopy("utils__parent-report-ui-explain", "the_information_is_relatively_current"),
  recent_but_partial: reportPackCopy("utils__parent-report-ui-explain", "partially_current_details_are_still_missing"),
  aging: reportPackCopy("utils__parent-report-ui-explain", "the_information_is_starting_to_age"),
  stale: "The information is less current - don't rely on it alone",
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_how_fresh_the_information_is"),
};

export const CONCLUSION_FRESHNESS_LABEL_HE = {
  high: reportPackCopy("utils__parent-report-ui-explain", "what_the_report_shows_is_fairly_reasonable_right_now"),
  medium: "What the report shows is still solidifying - we'll keep checking",
  low: reportPackCopy("utils__parent-report-ui-explain", "what_the_report_shows_is_still_tentative_a_bit_more_information_would_he"),
  expired: reportPackCopy("utils__parent-report-ui-explain", "what_the_report_shows_is_no_longer_current_worth_reviewing_again"),
};
...
export const NEXT_SUPPORT_ADJUSTMENT_LABEL_HE = {
  continue_same_plan: reportPackCopy("utils__parent-report-ui-explain", "continue_with_the_same_plan_carefully_and_with_re_checking"),
  continue_and_reduce_support: "Continue and slightly reduce guidance when there's a sign of independence",
  continue_and_tighten_focus: reportPackCopy("utils__parent-report-ui-explain", "continue_narrow_to_one_goal_and_shorten_the_session_if_needed"),
  pause_and_observe: reportPackCopy("utils__parent-report-ui-explain", "pause_for_a_moment_observe_and_gather_more_information_before_changing"),
  recheck_before_advancing: reportPackCopy("utils__parent-report-ui-explain", "one_more_short_check_before_raising_difficulty_or_level"),
...
export const SUPPORT_SEQUENCE_STATE_LABEL_HE = {
  new_support_cycle: reportPackCopy("utils__parent-report-ui-explain", "starting_new_support_in_the_first_days_watch_the_results_without_rushing"),
  early_sequence: reportPackCopy("utils__parent-report-ui-explain", "start_of_new_support_keep_tracking_without_overloading"),
  continuing_sequence: reportPackCopy("utils__parent-report-ui-explain", "continuing_in_the_same_direction_which_looks_good"),
  sequence_ready_for_release: reportPackCopy("utils__parent-report-ui-explain", "support_can_be_reduced_a_little"),
  sequence_stalled: "The direction isn't progressing enough - narrow the goal or change approach",
  sequence_exhausted: reportPackCopy("utils__parent-report-ui-explain", "practice_is_repeating_too_much_worth_pausing_and_trying_a_different_appr"),
  insufficient_sequence_evidence: reportPackCopy("utils__parent-report-ui-explain", "still_limited_experience_worth_checking_again_after_a_bit_more_practice"),
};

export const PRIOR_SUPPORT_PATTERN_LABEL_HE = {
  guided_repeat: reportPackCopy("utils__parent-report-ui-explain", "similar_guided_support_repeated_over_time"),
  guided_then_release: reportPackCopy("utils__parent-report-ui-explain", "guided_then_a_gradual_move_toward_more_independence"),
  ...
  mixed_support_history: reportPackCopy("utils__parent-report-ui-explain", "an_inconsistent_mix_of_support"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_what_past_support_looked_like"),
};

export const STRATEGY_REPETITION_RISK_LABEL_HE = {
  low: reportPackCopy("utils__parent-report-ui-explain", "low_risk_of_unnecessarily_repeating_the_same_method"),
  moderate: reportPackCopy("utils__parent-report-ui-explain", "moderate_risk_of_repeating_the_same_direction_without_change"),
  high: reportPackCopy("utils__parent-report-ui-explain", "high_risk_of_repeating_the_same_kind_of_help_without_added_benefit"),
  unknown: "Not clear if there's risky repetition",
};

export const STRATEGY_FATIGUE_RISK_LABEL_HE = {
  low: reportPackCopy("utils__parent-report-ui-explain", "low_load_right_now"),
  ...
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_regarding_fatigue_with_the_approach"),
};

export const NEXT_BEST_SEQUENCE_STEP_LABEL_HE = {
  continue_current_sequence: reportPackCopy("utils__parent-report-ui-explain", "continue_in_the_same_direction_a_bit_longer_and_check_again"),
  begin_release_step: "Start reducing help carefully - don't switch all at once",
  tighten_same_goal: reportPackCopy("utils__parent-report-ui-explain", "narrow_the_same_goal_instead_of_expanding"),
  switch_support_type: reportPackCopy("utils__parent-report-ui-explain", "switch_the_type_of_support_not_just_another_repetition"),
  reset_with_short_review: "A short reset and re-check before pushing further",
  observe_before_next_cycle: reportPackCopy("utils__parent-report-ui-explain", "observe_and_gather_information_before_a_new_cycle"),
};

/** Phase 11 — next week's support sequence action (engine) */
export const NEXT_SUPPORT_SEQUENCE_ACTION_LABEL_HE = {
  continue_same_sequence: reportPackCopy("utils__parent-report-ui-explain", "continue_in_the_same_direction_without_a_big_change"),
  continue_with_tighter_target: reportPackCopy("utils__parent-report-ui-explain", "continue_in_the_same_direction_with_a_more_focused_goal"),
  begin_release_sequence: reportPackCopy("utils__parent-report-ui-explain", "start_a_gradual_process_of_reducing_help"),
  pause_repeat_and_switch: reportPackCopy("utils__parent-report-ui-explain", "pause_repetitions_and_switch_direction"),
  short_reset_then_retry: "A short reset, then try again",
  observe_without_new_push: reportPackCopy("utils__parent-report-ui-explain", "observe_without_a_new_push_right_now"),
};
...
export const ADVICE_SIMILARITY_LEVEL_LABEL_HE = {
  ...
  partly_repeated: reportPackCopy("utils__parent-report-ui-explain", "some_things_repeat_a_slight_variation_could_help"),
  mostly_repeated: reportPackCopy("utils__parent-report-ui-explain", "most_of_the_wording_repeats_itself_worth_changing_the_angle"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_if_this_is_a_repetition"),
};
...
export const ADVICE_NOVELTY_LABEL_HE = {
  ...
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear"),
};

export const RECOMMENDATION_ROTATION_NEED_LABEL_HE = {
  none: reportPackCopy("utils__parent-report-ui-explain", "no_need_to_update_the_direction_of_the_recommendation"),
  light_variation: "It's enough to lightly update the wording or the step",
  meaningful_rotation: reportPackCopy("utils__parent-report-ui-explain", "worth_changing_significantly_not_the_same_repeated_exercise"),
...
export const RECOMMENDATION_MEMORY_STATE_LABEL_HE = {
  no_memory: reportPackCopy("utils__parent-report-ui-explain", "still_limited_experience_from_the_past_worth_checking_again_after_a_bit_"),
  light_memory: reportPackCopy("utils__parent-report-ui-explain", "only_limited_information_from_the_past_mostly_from_the_current_period"),
  usable_memory: reportPackCopy("utils__parent-report-ui-explain", "enough_background_to_compare_progress_against_what_happened_recently"),
  strong_memory: reportPackCopy("utils__parent-report-ui-explain", "several_periods_to_compare_continuity_can_be_trusted_a_bit_more"),
};

export const PRIOR_RECOMMENDATION_SIGNATURE_LABEL_HE = {
  guided_accuracy_path: reportPackCopy("utils__parent-report-ui-explain", "previous_attempt_to_stabilize_accuracy_through_guided_practice"),
  review_hold_path: reportPackCopy("utils__parent-report-ui-explain", "review_and_holding_steady_before_a_change"),
  ...
  mixed_prior_path: reportPackCopy("utils__parent-report-ui-explain", "several_approaches_tried_without_one_clear_direction"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_what_past_support_looked_like"),
};

export const SUPPORT_HISTORY_DEPTH_LABEL_HE = {
  single_window: reportPackCopy("utils__parent-report-ui-explain", "information_from_a_single_period_only"),
  short_history: reportPackCopy("utils__parent-report-ui-explain", "data_from_two_periods_to_compare"),
  multi_window: reportPackCopy("utils__parent-report-ui-explain", "several_periods_a_stronger_basis"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_how_much_history_is_available"),
};

export const RECOMMENDATION_CARRYOVER_LABEL_HE = {
  not_visible: reportPackCopy("utils__parent-report-ui-explain", "no_clear_continuity_is_visible_from_the_previous_direction"),
  partly_visible: reportPackCopy("utils__parent-report-ui-explain", "the_same_direction_may_be_continuing_but_not_conclusively"),
  clearly_visible: reportPackCopy("utils__parent-report-ui-explain", "it_looks_like_the_same_support_direction_is_continuing_into_this_period_"),
  unclear: reportPackCopy("utils__parent-report-ui-explain", "not_clear_if_this_is_the_same_approach_or_a_small_change"),
};

export const MEMORY_OF_PRIOR_SUPPORT_CONFIDENCE_LABEL_HE = {
  none: reportPackCopy("utils__parent-report-ui-explain", "still_not_a_strong_enough_basis_to_compare_with_the_past"),
  low: reportPackCopy("utils__parent-report-ui-explain", "the_comparison_with_the_past_is_still_weak"),
  medium: reportPackCopy("utils__parent-report-ui-explain", "enough_background_for_a_careful_comparison_with_the_past"),
...
export const EXPECTED_OUTCOME_TYPE_LABEL_HE = {
  accuracy_stabilization: reportPackCopy("utils__parent-report-ui-explain", "we_wanted_to_stabilize_accuracy"),
  independence_growth: reportPackCopy("utils__parent-report-ui-explain", "we_wanted_to_build_independence"),
  error_reduction: reportPackCopy("utils__parent-report-ui-explain", "we_wanted_to_reduce_recurring_mistakes"),
  retention_hold: reportPackCopy("utils__parent-report-ui-explain", "we_wanted_retention_and_consistency"),
  release_readiness: reportPackCopy("utils__parent-report-ui-explain", "we_wanted_to_see_if_help_could_be_carefully_reduced"),
  evidence_collection: reportPackCopy("utils__parent-report-ui-explain", "we_wanted_to_gather_a_bit_more_information"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_what_we_were_actually_trying_to_improve"),
};

export const OBSERVED_OUTCOME_STATE_LABEL_HE = {
  clear_progress: reportPackCopy("utils__parent-report-ui-explain", "in_practice_we_see_clear_improvement_in_the_direction_we_wanted"),
  partial_progress: "In practice, there's partial progress",
  flat_response: reportPackCopy("utils__parent-report-ui-explain", "in_practice_the_picture_is_fairly_flat"),
  contradictory_response: reportPackCopy("utils__parent-report-ui-explain", "in_practice_the_direction_differs_from_what_we_expected"),
  not_observable_yet: reportPackCopy("utils__parent-report-ui-explain", "still_too_early_to_see_a_clear_result"),
};
...
export const FOLLOW_THROUGH_SIGNAL_LABEL_HE = {
  ...
  possibly_followed: reportPackCopy("utils__parent-report-ui-explain", "the_direction_may_have_been_followed_not_conclusive"),
  unclear: reportPackCopy("utils__parent-report-ui-explain", "not_clear_if_the_same_direction_was_followed_at_home"),
  not_inferable: reportPackCopy("utils__parent-report-ui-explain", "cannot_be_inferred_from_the_data"),
};
...
export const RECOMMENDATION_CONTINUATION_DECISION_LABEL_HE = {
  ...
  continue_but_refine: reportPackCopy("utils__parent-report-ui-explain", "continue_in_the_same_direction_more_precisely"),
...
export const OUTCOME_BASED_NEXT_MOVE_LABEL_HE = {
  keep_current_direction: reportPackCopy("utils__parent-report-ui-explain", "stay_on_this_direction_and_check_again_later"),
  tighten_goal_definition: "Narrow the goal - don't expand it",
  reduce_support_and_check_transfer: reportPackCopy("utils__parent-report-ui-explain", "reduce_support_a_little_and_check_if_it_holds_on_a_new_question_too"),
  collect_new_evidence_first: reportPackCopy("utils__parent-report-ui-explain", "gather_more_information_before_a_major_decision"),
  switch_path_type: reportPackCopy("utils__parent-report-ui-explain", "switch_the_approach_not_just_another_round"),
...
export const GATE_STATE_LABEL_HE = {
  ...
  continue_gate_active: reportPackCopy("utils__parent-report-ui-explain", "the_current_direction_needs_a_bit_more_proof_before_changing"),
  release_gate_forming: reportPackCopy("utils__parent-report-ui-explain", "getting_closer_to_reducing_help_still_missing_one_short_sign_of_independ"),
  pivot_gate_visible: "If there's still no improvement after more practice - worth considering a slightly different direction",
  recheck_gate_visible: reportPackCopy("utils__parent-report-ui-explain", "missing_current_information_worth_gathering_a_bit_more_before_deciding"),
  advance_gate_forming: "There's a good basis - don't raise the level too fast without a clearly repeating success",
  mixed_gate_state: reportPackCopy("utils__parent-report-ui-explain", "several_things_at_once_one_clear_step_first"),
};

export const GATE_READINESS_LABEL_HE = {
  low: reportPackCopy("utils__parent-report-ui-explain", "low_readiness_not_locking_into_anything_definitive"),
  moderate: reportPackCopy("utils__parent-report-ui-explain", "moderate_readiness_can_be_narrowed_to_one_step"),
  high: reportPackCopy("utils__parent-report-ui-explain", "relatively_high_readiness_still_with_conditions_before_reducing_help_or_"),
  insufficient: reportPackCopy("utils__parent-report-ui-explain", "not_yet_enough_basis_for_a_precise_decision"),
};

export const GATE_LEVEL_LABEL_HE = {
  off: reportPackCopy("utils__parent-report-ui-explain", "not_relevant_right_now"),
  pending: reportPackCopy("utils__parent-report-ui-explain", "waiting_for_one_more_short_sign"),
  forming: reportPackCopy("utils__parent-report-ui-explain", "building_gradually"),
  ready_watch: reportPackCopy("utils__parent-report-ui-explain", "almost_there_one_last_condition_remains"),
...
export const TARGET_EVIDENCE_TYPE_LABEL_HE = {
  accuracy_confirmation: reportPackCopy("utils__parent-report-ui-explain", "confirm_that_accuracy_holds_without_unnecessary_pressure"),
  independence_confirmation: reportPackCopy("utils__parent-report-ui-explain", "see_a_short_success_without_help_in_the_middle"),
  retention_confirmation: reportPackCopy("utils__parent-report-ui-explain", "see_that_the_child_remembers_even_after_a_short_break"),
  mistake_reduction_confirmation: reportPackCopy("utils__parent-report-ui-explain", "see_fewer_mistakes_of_the_same_kind"),
  response_confirmation: reportPackCopy("utils__parent-report-ui-explain", "see_how_the_child_responds_to_practice_at_home"),
  fresh_data_needed: reportPackCopy("utils__parent-report-ui-explain", "gather_a_bit_more_current_data_before_closing_the_picture"),
  mixed_target: reportPackCopy("utils__parent-report-ui-explain", "combine_two_short_signs_not_everything_at_once"),
};

export const TARGET_OBSERVATION_WINDOW_LABEL_HE = {
  next_short_cycle: reportPackCopy("utils__parent-report-ui-explain", "in_the_coming_days_one_or_two_sessions"),
  next_two_cycles: reportPackCopy("utils__parent-report-ui-explain", "within_the_next_two_short_practice_sequences"),
  needs_fresh_baseline: reportPackCopy("utils__parent-report-ui-explain", "after_a_short_check_to_refresh_the_picture"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear_how_much_time_is_needed"),
};

/** Phase 13 — decision focus for the next round */
export const NEXT_CYCLE_DECISION_FOCUS_LABEL_HE = {
  prove_current_direction: reportPackCopy("utils__parent-report-ui-explain", "check_that_the_current_direction_is_really_helping"),
  check_independence_before_release: reportPackCopy("utils__parent-report-ui-explain", "check_for_short_independence_before_reducing_help"),
  stabilize_before_advance: reportPackCopy("utils__parent-report-ui-explain", "stabilize_before_raising_the_level"),
  test_if_path_is_working: reportPackCopy("utils__parent-report-ui-explain", "check_if_the_direction_is_actually_working_after_a_bit_more_practice"),
  refresh_baseline_before_decision: reportPackCopy("utils__parent-report-ui-explain", "recheck_the_simpler_parts_before_a_big_decision"),
  prepare_for_controlled_release: reportPackCopy("utils__parent-report-ui-explain", "prepare_to_reduce_help_gradually_not_switch_to_independent_all_at_once"),
};
...
export const FOUNDATIONAL_BLOCKER_LABEL_HE = {
  ...
  instruction_language_load: reportPackCopy("utils__parent-report-ui-explain", "the_wording_of_the_task_adds_extra_load"),
  independence_readiness_gap: reportPackCopy("utils__parent-report-ui-explain", "still_early_for_full_independent_work"),
  retention_instability: "The child still doesn't retain the method over time",
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_yet_clear_exactly_what_needs_reinforcing_first"),
};

export const LIKELIHOOD_LOW_MOD_HIGH_HE = {
  low: reportPackCopy("utils__parent-report-ui-explain", "less_likely"),
  moderate: reportPackCopy("utils__parent-report-ui-explain", "moderate_likelihood"),
  high: reportPackCopy("utils__parent-report-ui-explain", "fairly_likely"),
  unknown: reportPackCopy("utils__parent-report-ui-explain", "not_clear"),
};

/** Phase 14 — intervention order */
export const INTERVENTION_ORDERING_LABEL_HE = {
  foundation_first: reportPackCopy("utils__parent-report-ui-explain", "first_reinforce_the_simpler_parts_then_return_to_the_topic_itself"),
  local_support_first: reportPackCopy("utils__parent-report-ui-explain", "focused_practice_on_the_topic_itself_first"),
  parallel_light_support: reportPackCopy("utils__parent-report-ui-explain", "light_practice_in_parallel_without_expanding_everything_at_once"),
  gather_dependency_evidence_first: reportPackCopy("utils__parent-report-ui-explain", "gather_more_information_before_deciding_what_to_reinforce_first"),
};

/** Phase 14 — foundation decision for the next round */
export const FOUNDATION_DECISION_LABEL_HE = {
  stabilize_foundation_first: reportPackCopy("utils__parent-report-ui-explain", "reinforce_the_simpler_parts_first_before_expanding"),
  treat_locally: reportPackCopy("utils__parent-report-ui-explain", "address_the_topic_itself_without_expanding_beyond_what_the_data_shows"),
  run_parallel_light_support: reportPackCopy("utils__parent-report-ui-explain", "combine_short_practice_of_the_simpler_parts_together_with_the_topic_itse"),
  collect_dependency_evidence_first: reportPackCopy("utils__parent-report-ui-explain", "gather_information_before_changing_the_order_of_work"),
};

export const NEXT_CYCLE_SUPPORT_LEVEL_LABEL_HE = {
  narrow_local: reportPackCopy("utils__parent-report-ui-explain", "focused_practice_on_the_topic"),
  foundation_targeted: reportPackCopy("utils__parent-report-ui-explain", "focused_practice_on_the_simpler_parts_that_need_reinforcing"),
...
function topicNarrativeSectionLineHe(rowOrRec, section, max = 180) {
  ...
  return line ? truncateHe(normalizeParentFacing(line), max) : "";
}
