...
import {
  ...
  resolveParentFacingPatternLabel as resolveParentFacingPatternLabel
...
const MEANING_BY_ROOT_CAUSE_INSIGHT = Object.freeze({
  knowledge_gap: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_data_points_to_a_skill_that_is_still_not_fully_stable"),
  speed_pressure: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "some_of_the_mistakes_look_related_to_speed_not_necessarily_a_full_knowle"),
  instruction_friction: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_difficulty_may_be_related_to_understanding_the_instructions_not_just"),
  careless_execution: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_material_looks_partly_familiar_but_there_are_execution_mistakes_that"),
  weak_independence: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_does_better_with_support_and_it_still_helps_to_build_up_indepe"),
  insufficient_evidence: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_still_only_a_few_answers_a_little_more_practice_would_help_bef"),
  preliminary_direction: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_is_an_early_direction_but_a_bit_more_practice_would_help_before_dr"),
  recurring_pattern:
  ...
  no_consistent_pattern: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_is_already_some_practice_in_this_topic_but_a_consistent_enough_pat"),
  mixed_signal: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_a_few_possible_directions_worth_checking_again_after_a_bit_mor"),
  early_stage_instability: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_still_only_a_few_answers_a_little_more_practice_would_help_bef"),
  mixed: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_a_few_possible_directions_worth_checking_again_after_a_bit_mor")
});
...
const MEANING_BY_BEHAVIOR_EXPLAIN = Object.freeze({
  ...
  careless_execution:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_seems_to_know_part_of_the_material_but_there_are_execution_mis"),
  careless_pattern:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_seems_to_know_part_of_the_material_but_there_are_execution_mis"),
  weak_independence:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_does_better_with_support_or_hints_and_it_still_helps_to_build_"),
  stable_mastery:
  ...
  insufficient_evidence:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_still_only_a_few_answers_a_little_more_practice_would_help_bef"),
  undetermined:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_still_only_a_few_answers_a_little_more_practice_would_help_bef"),
  mixed_low_signal:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_still_only_a_few_answers_a_little_more_practice_would_help_bef"),
...
const ACTION_BY_ROOT_CAUSE = Object.freeze({
  ...
  speed_pressure: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "solve_a_few_questions_without_a_timer_pause_before_submitting_and_check_"),
  instruction_friction:
  ...
  preliminary_direction: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "do_a_few_more_questions_on_this_topic_then_check_the_report_again"),
  recurring_pattern:
  ...
  early_stage_instability:
    reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "do_a_few_more_questions_on_this_topic_then_check_the_report_again")
});
...
export const MISTAKE_PATTERN_PARENT_HE = Object.freeze({
  ...
  recurring_weakness: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "some_mistakes_repeat_in_the_same_type_of_activity"),
  insufficient_recurrence: "",
  early_signal: "",
  speed_driven_error: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "some_mistakes_happened_while_working_quickly"),
  instruction_misread: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "some_mistakes_appear_related_to_understanding_the_instructions"),
  support_dependent_success: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "success_mostly_happens_with_guidance_or_hints"),
  careless_flip: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "small_execution_mistakes_that_repeat_when_working_quickly"),
  concept_confusion: "",
  procedure_break: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "confusion_about_the_order_of_steps_in_solving"),
...
export const DEPENDENCY_STATE_PARENT_HE = Object.freeze({
  ...
  likely_local_issue: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_signs_mostly_point_to_a_difficulty_within_this_topic_itself"),
...
function adjustInsufficientEvidenceByQHe(text, q) {
  ...
  if (n <= 15) return reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_is_an_early_direction_but_a_bit_more_practice_would_help_before_dr");
...
export function explainPatternHe(patternText) {
  const mapped = resolveParentFacingPatternLabel(patternText);
...
export const PARENT_DIAGNOSTIC_TYPE_LABEL_HE = Object.freeze({
  ...
  speed_pressure: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "some_of_the_mistakes_look_related_to_speed_or_time_pressure"),
  instruction_friction: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_difficulty_may_be_related_to_reading_the_instructions_or_understandi"),
  careless_pattern: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_seems_to_know_part_of_the_material_but_there_are_execution_mis"),
  careless_execution: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_seems_to_know_part_of_the_material_but_there_are_execution_mis"),
  fragile_success: "The child gets to some of the correct answers, but consistency isn't fully there yet.",
  stable_mastery: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_data_points_to_good_command_of_the_topic_right_now"),
  undetermined: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "no_clear_pattern_has_been_established_for_this_topic_yet"),
  ...
  mixed_signal: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_signs_pointing_in_a_few_different_directions_so_the_report_rec"),
  mixed: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_signs_pointing_in_a_few_different_directions_so_the_report_rec"),
  weak_independence: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "the_child_does_better_with_support_or_hints_and_it_still_helps_to_build_"),
  none_sparse: reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "there_are_too_few_questions_on_this_topic_to_draw_a_clear_conclusion_fro"),
...
export function parentDiagnosticTypeLabelHe(diagnosticType) {
  ...
  return k ? "What was seen in practice" : reportPackCopy("utils__parent-report-language__parent-report-copy-spec", "no_clear_pattern_has_been_established_for_this_topic_yet");
}
