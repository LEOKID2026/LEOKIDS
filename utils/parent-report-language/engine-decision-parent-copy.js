...
import { subjectLabel as subjectLabelFromId } from "../../lib/teacher-portal/teacher-ui.js";
...
function subjectLabel(subject, subjectId) {
  ...
  if (s) return s;
  return subjectLabelFromId(String(subjectId || "")) || "";
}
...
function buildDiagnosticBodyByDecision(p) {
  const subj = subjectLabel(p.subjectLabel, p.subjectId);
