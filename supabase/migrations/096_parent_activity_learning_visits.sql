-- Parent-assigned activity ΓÇö per-visit learning time (not answer rows).
-- Owner must apply manually. Agent must NOT run this migration.
--
-- ╫₧╫º╫ò╫¿ ╫É╫₧╫¬ ╫£╫û╫₧╫ƒ ╫£╫₧╫Ö╫ô╫ö ╫æ╫ñ╫ó╫Ö╫£╫ò╫¬ ╫₧╫ö╫ò╫¿╫ö: ╫¢╫£ ╫æ╫Ö╫º╫ò╫¿ = ╫⌐╫ò╫¿╫ö ╫á╫ñ╫¿╫ô╫¬.
-- idempotency: (student_id, client_visit_token) ΓÇö ╫£╫É ╫£╫ñ╫Ö question_index.
